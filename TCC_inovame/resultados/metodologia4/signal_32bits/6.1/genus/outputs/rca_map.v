...
// Generated on: Apr 14 2025 14:17:47 -03 (Apr 14 2025 17:17:47 UTC)
...
module signal_32bits(A, B, Cin, S, Cout);
  ...
  sky130_fd_sc_hd__fa_1 addinc_add_7_30_g1260__1705(.A (n_66), .B
       (n_67), .CIN (n_65), .COUT (addinc_add_7_30_n_108), .SUM (S[0]));
  ...
  sky130_fd_sc_hd__nand2_1 addinc_add_7_30_g1312__5477(.A (n_34), .B
       (n_13), .Y (addinc_add_7_30_n_58));
  sky130_fd_sc_hd__and2_1 addinc_add_7_30_g1313__2398(.A (n_45), .B
       (n_57), .X (addinc_add_7_30_n_57));
  sky130_fd_sc_hd__nor2_1 addinc_add_7_30_g1314__5107(.A (n_17), .B
       (n_8), .Y (addinc_add_7_30_n_56));
  sky130_fd_sc_hd__nand2_1 addinc_add_7_30_g1315__6260(.A (n_10), .B
       (n_20), .Y (addinc_add_7_30_n_55));
  sky130_fd_sc_hd__and2_1 addinc_add_7_30_g1316__4319(.A (n_15), .B
       (n_27), .X (addinc_add_7_30_n_54));
  sky130_fd_sc_hd__nand2_1 addinc_add_7_30_g1317__8428(.A (n_32), .B
       (n_33), .Y (addinc_add_7_30_n_53));
  sky130_fd_sc_hd__or2_1 addinc_add_7_30_g1318__5526(.A (n_33), .B
       (n_32), .X (addinc_add_7_30_n_52));
  sky130_fd_sc_hd__or2_1 addinc_add_7_30_g1319__6783(.A (n_28), .B
       (n_38), .X (addinc_add_7_30_n_51));
  sky130_fd_sc_hd__nand2_1 addinc_add_7_30_g1320__3680(.A (n_64), .B
       (n_52), .Y (addinc_add_7_30_n_50));
  sky130_fd_sc_hd__nand2_1 addinc_add_7_30_g1321__1617(.A (n_8), .B
       (n_17), .Y (addinc_add_7_30_n_49));
  sky130_fd_sc_hd__nor2_1 addinc_add_7_30_g1322__2802(.A (n_62), .B
       (n_31), .Y (addinc_add_7_30_n_48));
  sky130_fd_sc_hd__nand2_1 addinc_add_7_30_g1323__1705(.A (n_53), .B
       (n_47), .Y (addinc_add_7_30_n_47));
  sky130_fd_sc_hd__nor2_1 addinc_add_7_30_g1324__5122(.A (n_6), .B
       (n_16), .Y (addinc_add_7_30_n_46));
  sky130_fd_sc_hd__nor2_1 addinc_add_7_30_g1325__8246(.A (n_5), .B
       (n_3), .Y (addinc_add_7_30_n_45));
  sky130_fd_sc_hd__nand2_1 addinc_add_7_30_g1326__7098(.A (n_11), .B
       (n_24), .Y (addinc_add_7_30_n_44));
  sky130_fd_sc_hd__nand2_1 addinc_add_7_30_g1327__6131(.A (n_16), .B
       (n_6), .Y (addinc_add_7_30_n_43));
  sky130_fd_sc_hd__nand2_1 addinc_add_7_30_g1328__1881(.A (n_26), .B
       (n_55), .Y (addinc_add_7_30_n_42));
  sky130_fd_sc_hd__or2_1 addinc_add_7_30_g1329__5115(.A (n_27), .B
       (n_15), .X (addinc_add_7_30_n_41));
  sky130_fd_sc_hd__nand2_1 addinc_add_7_30_g1330__7482(.A (n_35), .B
       (n_21), .Y (addinc_add_7_30_n_40));
  sky130_fd_sc_hd__nor2_1 addinc_add_7_30_g1331__4733(.A (n_2), .B
       (n_1), .Y (addinc_add_7_30_n_39));
  sky130_fd_sc_hd__or2_1 addinc_add_7_30_g1332__6161(.A (n_57), .B
       (n_45), .X (addinc_add_7_30_n_38));
  sky130_fd_sc_hd__nor2_1 addinc_add_7_30_g1333__9315(.A (n_36), .B
       (n_18), .Y (addinc_add_7_30_n_37));
  sky130_fd_sc_hd__nor2_1 addinc_add_7_30_g1334__9945(.A (n_47), .B
       (n_53), .Y (addinc_add_7_30_n_35));
  sky130_fd_sc_hd__nor2_1 addinc_add_7_30_g1335__2883(.A (n_13), .B
       (n_34), .Y (addinc_add_7_30_n_33));
  sky130_fd_sc_hd__nor2_1 addinc_add_7_30_g1336__2346(.A (n_21), .B
       (n_35), .Y (addinc_add_7_30_n_32));
  sky130_fd_sc_hd__nor2_1 addinc_add_7_30_g1337__1666(.A (n_24), .B
       (n_11), .Y (addinc_add_7_30_n_31));
  ...
  sky130_fd_sc_hd__nand2_1 addinc_add_7_30_g1343__7410(.A (n_31), .B
       (n_62), .Y (addinc_add_7_30_n_30));
  sky130_fd_sc_hd__nand2_1 addinc_add_7_30_g1344__6417(.A (n_43), .B
       (n_29), .Y (addinc_add_7_30_n_29));
  sky130_fd_sc_hd__and2_1 addinc_add_7_30_g1345__5477(.A (n_38), .B
       (n_28), .X (addinc_add_7_30_n_28));
  sky130_fd_sc_hd__nand2_1 addinc_add_7_30_g1346__2398(.A (n_25), .B
       (n_49), .Y (addinc_add_7_30_n_27));
  sky130_fd_sc_hd__nand2_1 addinc_add_7_30_g1347__5107(.A (n_3), .B
       (n_5), .Y (addinc_add_7_30_n_26));
  sky130_fd_sc_hd__and2_1 addinc_add_7_30_g1348__6260(.A (n_22), .B
       (n_56), .X (addinc_add_7_30_n_25));
  sky130_fd_sc_hd__nand2_1 addinc_add_7_30_g1349__4319(.A (n_50), .B
       (n_42), .Y (addinc_add_7_30_n_24));
  sky130_fd_sc_hd__nand2_1 addinc_add_7_30_g1350__8428(.A (n_18), .B
       (n_36), .Y (addinc_add_7_30_n_23));
  sky130_fd_sc_hd__nand2_1 addinc_add_7_30_g1351__5526(.A (n_51), .B
       (n_58), .Y (addinc_add_7_30_n_22));
  sky130_fd_sc_hd__nand2_1 addinc_add_7_30_g1352__6783(.A (n_19), .B
       (n_40), .Y (addinc_add_7_30_n_21));
  sky130_fd_sc_hd__nor2_1 addinc_add_7_30_g1353__3680(.A (n_58), .B
       (n_51), .Y (addinc_add_7_30_n_20));
  sky130_fd_sc_hd__nand2_1 addinc_add_7_30_g1354__1617(.A (n_1), .B
       (n_2), .Y (addinc_add_7_30_n_19));
  sky130_fd_sc_hd__or2_1 addinc_add_7_30_g1355__2802(.A (n_14), .B
       (n_46), .X (addinc_add_7_30_n_18));
  sky130_fd_sc_hd__nand2_1 addinc_add_7_30_g1356__1705(.A (n_39), .B
       (n_37), .Y (addinc_add_7_30_n_17));
  sky130_fd_sc_hd__or2_1 addinc_add_7_30_g1357__5122(.A (n_56), .B
       (n_22), .X (addinc_add_7_30_n_16));
  sky130_fd_sc_hd__nor2_1 addinc_add_7_30_g1358__8246(.A (n_37), .B
       (n_39), .Y (addinc_add_7_30_n_15));
  sky130_fd_sc_hd__nand2_1 addinc_add_7_30_g1359__7098(.A (n_23), .B
       (n_44), .Y (addinc_add_7_30_n_14));
  sky130_fd_sc_hd__nor2_1 addinc_add_7_30_g1360__6131(.A (n_44), .B
       (n_23), .Y (addinc_add_7_30_n_13));
  sky130_fd_sc_hd__nand2_1 addinc_add_7_30_g1361__1881(.A (n_46), .B
       (n_14), .Y (addinc_add_7_30_n_12));
  sky130_fd_sc_hd__nor2_1 addinc_add_7_30_g1362__5115(.A (n_42), .B
       (n_50), .Y (addinc_add_7_30_n_10));
  sky130_fd_sc_hd__nor2_1 addinc_add_7_30_g1363__7482(.A (n_49), .B
       (n_25), .Y (addinc_add_7_30_n_9));
  sky130_fd_sc_hd__nor2_1 addinc_add_7_30_g1364__4733(.A (n_40), .B
       (n_19), .Y (addinc_add_7_30_n_7));
  sky130_fd_sc_hd__nor2_1 addinc_add_7_30_g1365__6161(.A (n_55), .B
       (n_26), .Y (addinc_add_7_30_n_6));
  sky130_fd_sc_hd__nor2_1 addinc_add_7_30_g1366__9315(.A (n_52), .B
       (n_64), .Y (addinc_add_7_30_n_4));
  sky130_fd_sc_hd__nor2_1 addinc_add_7_30_g1367__9945(.A (n_29), .B
       (n_43), .Y (addinc_add_7_30_n_3));
  sky130_fd_sc_hd__nor2_1 addinc_add_7_30_g1368__2883(.A (n_20), .B
       (n_10), .Y (addinc_add_7_30_n_1));
endmodule
