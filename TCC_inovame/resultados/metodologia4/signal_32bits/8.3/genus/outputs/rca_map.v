...
module signal_32bits(A, B, Cin, S, Cout);
  ...
  sky130_fd_sc_hd__fa_1 addinc_add_7_30_g1265__5477(.A (n_24), .B
       (n_10), .CIN (addinc_add_7_30_n_124), .COUT
       (addinc_add_7_30_n_127), .SUM (S[7]));
  sky130_fd_sc_hd__fa_1 addinc_add_7_30_g1266__2398(.A (n_20), .B
  ...
  sky130_fd_sc_hd__fa_1 addinc_add_7_30_g1273__6783(.A (n_9), .B (n_3),
       .CIN (addinc_add_7_30_n_114), .COUT (addinc_add_7_30_n_117),
       .SUM (S[3]));
  sky130_fd_sc_hd__fa_1 addinc_add_7_30_g1274__3680(.A (n_5), .B (n_1),
       .CIN (addinc_add_7_30_n_112), .COUT (addinc_add_7_30_n_114),
       .SUM (S[2]));
  sky130_fd_sc_hd__fa_1 addinc_add_7_30_g1275__1617(.A (n_2), .B (n_0),
  ...
  sky130_fd_sc_hd__fa_1 addinc_add_7_30_g1278__5122(.A (n_59), .B
  ...
  sky130_fd_sc_hd__nand2_1 addinc_add_7_30_g1333__2398(.A (n_7), .B
       (n_17), .Y (addinc_add_7_30_n_58));
  sky130_fd_sc_hd__nor2_1 addinc_add_7_30_g1334__5107(.A (n_27), .B
       (n_11), .Y (addinc_add_7_30_n_57));
  sky130_fd_sc_hd__nand2_1 addinc_add_7_30_g1335__6260(.A (n_50), .B
       (n_14), .Y (addinc_add_7_30_n_56));
  sky130_fd_sc_hd__nand2_1 addinc_add_7_30_g1336__4319(.A (n_38), .B
       (n_37), .Y (addinc_add_7_30_n_55));
  sky130_fd_sc_hd__and2_1 addinc_add_7_30_g1337__8428(.A (n_18), .B
       (n_40), .X (addinc_add_7_30_n_54));
  sky130_fd_sc_hd__nand2_1 addinc_add_7_30_g1338__5526(.A (n_39), .B
       (n_52), .Y (addinc_add_7_30_n_53));
  sky130_fd_sc_hd__nor2_1 addinc_add_7_30_g1339__6783(.A (n_21), .B
       (n_34), .Y (addinc_add_7_30_n_52));
  sky130_fd_sc_hd__nand2_1 addinc_add_7_30_g1340__3680(.A (n_26), .B
       (n_62), .Y (addinc_add_7_30_n_51));
  sky130_fd_sc_hd__nand2_1 addinc_add_7_30_g1341__1617(.A (n_4), .B
       (n_12), .Y (addinc_add_7_30_n_50));
  sky130_fd_sc_hd__or2_1 addinc_add_7_30_g1342__2802(.A (n_44), .B
       (n_64), .X (addinc_add_7_30_n_49));
  sky130_fd_sc_hd__nand2_1 addinc_add_7_30_g1343__1705(.A (n_63), .B
       (n_29), .Y (addinc_add_7_30_n_48));
  sky130_fd_sc_hd__nand2_1 addinc_add_7_30_g1344__5122(.A (n_53), .B
       (n_56), .Y (addinc_add_7_30_n_47));
  sky130_fd_sc_hd__or2_1 addinc_add_7_30_g1345__8246(.A (n_42), .B
       (n_46), .X (addinc_add_7_30_n_46));
  sky130_fd_sc_hd__nand2_1 addinc_add_7_30_g1346__7098(.A (n_55), .B
       (n_57), .Y (addinc_add_7_30_n_45));
  sky130_fd_sc_hd__nand2_1 addinc_add_7_30_g1347__6131(.A (n_35), .B
       (n_28), .Y (addinc_add_7_30_n_44));
  sky130_fd_sc_hd__nor2_1 addinc_add_7_30_g1348__1881(.A (n_12), .B
       (n_4), .Y (addinc_add_7_30_n_43));
  sky130_fd_sc_hd__nand2_1 addinc_add_7_30_g1349__5115(.A (n_11), .B
       (n_27), .Y (addinc_add_7_30_n_42));
  sky130_fd_sc_hd__nand2_1 addinc_add_7_30_g1350__7482(.A (n_19), .B
       (n_43), .Y (addinc_add_7_30_n_41));
  sky130_fd_sc_hd__nand2_1 addinc_add_7_30_g1351__4733(.A (n_32), .B
       (n_36), .Y (addinc_add_7_30_n_40));
  sky130_fd_sc_hd__nor2_1 addinc_add_7_30_g1352__6161(.A (n_33), .B
       (n_15), .Y (addinc_add_7_30_n_39));
  sky130_fd_sc_hd__nor2_1 addinc_add_7_30_g1353__9315(.A (n_30), .B
       (n_51), .Y (addinc_add_7_30_n_37));
  sky130_fd_sc_hd__nor2_1 addinc_add_7_30_g1354__9945(.A (n_37), .B
       (n_38), .Y (addinc_add_7_30_n_34));
  sky130_fd_sc_hd__nor2_1 addinc_add_7_30_g1355__2883(.A (n_52), .B
       (n_39), .Y (addinc_add_7_30_n_33));
  sky130_fd_sc_hd__nor2_1 addinc_add_7_30_g1356__2346(.A (n_45), .B
       (n_22), .Y (addinc_add_7_30_n_32));
  sky130_fd_sc_hd__nor2_1 addinc_add_7_30_g1357__1666(.A (n_36), .B
       (n_32), .Y (addinc_add_7_30_n_30));
  sky130_fd_sc_hd__nor2_1 addinc_add_7_30_g1358__7410(.A (n_6), .B
       (n_31), .Y (addinc_add_7_30_n_28));
  ...
  sky130_fd_sc_hd__nand2_1 addinc_add_7_30_g1361__6417(.A (n_22), .B
       (n_45), .Y (addinc_add_7_30_n_27));
  sky130_fd_sc_hd__nand2_1 addinc_add_7_30_g1362__5477(.A (n_34), .B
       (n_21), .Y (addinc_add_7_30_n_26));
  sky130_fd_sc_hd__nand2_1 addinc_add_7_30_g1363__2398(.A (n_48), .B
       (n_58), .Y (addinc_add_7_30_n_25));
  sky130_fd_sc_hd__nand2_1 addinc_add_7_30_g1364__5107(.A (n_51), .B
       (n_30), .Y (addinc_add_7_30_n_24));
  sky130_fd_sc_hd__nand2_1 addinc_add_7_30_g1365__6260(.A (n_15), .B
       (n_33), .Y (addinc_add_7_30_n_23));
  sky130_fd_sc_hd__and2_1 addinc_add_7_30_g1366__4319(.A (n_46), .B
       (n_42), .X (addinc_add_7_30_n_22));
  sky130_fd_sc_hd__nand2_1 addinc_add_7_30_g1367__8428(.A (n_41), .B
       (n_47), .Y (addinc_add_7_30_n_21));
  sky130_fd_sc_hd__and2_1 addinc_add_7_30_g1368__5526(.A (n_25), .B
       (n_54), .X (addinc_add_7_30_n_20));
  sky130_fd_sc_hd__nand2_1 addinc_add_7_30_g1369__6783(.A (n_31), .B
       (n_6), .Y (addinc_add_7_30_n_19));
  sky130_fd_sc_hd__or2_1 addinc_add_7_30_g1370__3680(.A (n_40), .B
       (n_18), .X (addinc_add_7_30_n_18));
  sky130_fd_sc_hd__or2_1 addinc_add_7_30_g1371__1617(.A (n_43), .B
       (n_19), .X (addinc_add_7_30_n_17));
  sky130_fd_sc_hd__nor2_1 addinc_add_7_30_g1372__2802(.A (n_62), .B
       (n_26), .Y (addinc_add_7_30_n_16));
  sky130_fd_sc_hd__nand2_1 addinc_add_7_30_g1373__1705(.A (n_64), .B
       (n_44), .Y (addinc_add_7_30_n_15));
  sky130_fd_sc_hd__or2_1 addinc_add_7_30_g1374__5122(.A (n_54), .B
       (n_25), .X (addinc_add_7_30_n_14));
  sky130_fd_sc_hd__nand2_1 addinc_add_7_30_g1375__8246(.A (n_23), .B
       (n_49), .Y (addinc_add_7_30_n_13));
  sky130_fd_sc_hd__nand2_1 addinc_add_7_30_g1376__7098(.A (n_16), .B
       (n_13), .Y (addinc_add_7_30_n_12));
  sky130_fd_sc_hd__nor2_1 addinc_add_7_30_g1377__6131(.A (n_57), .B
       (n_55), .Y (addinc_add_7_30_n_11));
  sky130_fd_sc_hd__nor2_1 addinc_add_7_30_g1378__1881(.A (n_17), .B
       (n_7), .Y (addinc_add_7_30_n_10));
  sky130_fd_sc_hd__nor2_1 addinc_add_7_30_g1379__5115(.A (n_58), .B
       (n_48), .Y (addinc_add_7_30_n_9));
  sky130_fd_sc_hd__nor2_1 addinc_add_7_30_g1380__7482(.A (n_47), .B
       (n_41), .Y (addinc_add_7_30_n_8));
  sky130_fd_sc_hd__nor2_1 addinc_add_7_30_g1381__4733(.A (n_28), .B
       (n_35), .Y (addinc_add_7_30_n_7));
  sky130_fd_sc_hd__nor2_1 addinc_add_7_30_g1382__6161(.A (n_14), .B
       (n_50), .Y (addinc_add_7_30_n_5));
  sky130_fd_sc_hd__nor2_1 addinc_add_7_30_g1383__9315(.A (n_29), .B
       (n_63), .Y (addinc_add_7_30_n_4));
  sky130_fd_sc_hd__nor2_1 addinc_add_7_30_g1384__9945(.A (n_56), .B
       (n_53), .Y (addinc_add_7_30_n_2));
  sky130_fd_sc_hd__nor2_1 addinc_add_7_30_g1385__2883(.A (n_49), .B
       (n_23), .Y (addinc_add_7_30_n_1));
  sky130_fd_sc_hd__nor2_1 addinc_add_7_30_g1386__2346(.A (n_13), .B
