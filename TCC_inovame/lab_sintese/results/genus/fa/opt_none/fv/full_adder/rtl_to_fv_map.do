...
# Generated on: Tue Mar 18 13:23:11 -03 2025 (Tue Mar 18 16:23:11 UTC 2025)
...
set logfile fv/full_adder/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/full_adder -revised fv_map -use_rtl_names
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k ../rtl/full_adder.sv
elaborate_design -golden -root {full_adder} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/full_adder/fv_map.v.gz
elaborate_design -revised -root {full_adder}
...
set_analyze_option -mapping_file fv/full_adder/fv_map.map.do
...
set_system_mode lec
write_compared_points noneq.compared_points.full_adder.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.full_adder.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.full_adder.rtl.fv_map.rpt
