...
# Generated on: Wed Mar 19 16:21:47 -03 2025 (Wed Mar 19 19:21:47 UTC 2025)
...
set logfile fv/ripple_carry_adder_16bit/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/ripple_carry_adder_16bit -revised fv_map -use_rtl_names
...
add_search_path ../../FLP/gpdk045_workspace/gsclib045_all_v4.4/gsclib045/timing -library -both
read_library -liberty -both \
    /home/gme/guilherme.manske/TCC_inovame/genus/../../FLP/gpdk045_workspace/gsclib045_all_v4.4/gsclib045/timing/fast_vdd1v0_basicCells.lib \
    /home/gme/guilherme.manske/TCC_inovame/genus/../../FLP/gpdk045_workspace/gsclib045_all_v4.4/gsclib045/timing/slow_vdd1v0_basicCells.lib
...
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -sv09 ../rtl/componentes/half_adder.sv ../rtl/componentes/full_adder.sv ../rtl/somadores/normais/ripple_carry/ripple_carry_adder_16bit.sv
elaborate_design -golden -root {ripple_carry_adder_16bit} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/ripple_carry_adder_16bit/fv_map.v.gz
elaborate_design -revised -root {ripple_carry_adder_16bit}
...
set_analyze_option -mapping_file fv/ripple_carry_adder_16bit/fv_map.map.do
...
write_compared_points noneq.compared_points.ripple_carry_adder_16bit.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.ripple_carry_adder_16bit.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.ripple_carry_adder_16bit.rtl.fv_map.rpt
