...
# Generated on: Tue Mar 18 15:13:31 -03 2025 (Tue Mar 18 18:13:31 UTC 2025)
...
set logfile fv/carry_select_adder/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/carry_select_adder -revised fv_map -use_rtl_names
...
read_library -liberty -both \
    /home/gme/guilherme.manske/FLP/lab_sintese/genus/../../gpdk045_workspace/gsclib045_all_v4.4/gsclib045/timing/fast_vdd1v0_basicCells.lib \
    /home/gme/guilherme.manske/FLP/lab_sintese/genus/../../gpdk045_workspace/gsclib045_all_v4.4/gsclib045/timing/slow_vdd1v0_basicCells.lib
...
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -sv09 ../rtl/full_adder.sv ../rtl/ripple_carry_adder.sv ../rtl/carry_select_adder.sv
elaborate_design -golden -root {carry_select_adder} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/carry_select_adder/fv_map.v.gz
elaborate_design -revised -root {carry_select_adder}
...
set_analyze_option -mapping_file fv/carry_select_adder/fv_map.map.do
...
write_compared_points noneq.compared_points.carry_select_adder.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.carry_select_adder.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.carry_select_adder.rtl.fv_map.rpt
