...
# Generated on: Wed Mar 19 15:57:50 -03 2025 (Wed Mar 19 18:57:50 UTC 2025)
...
set logfile fv/cla_16bits/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/cla_16bits -revised fv_map -use_rtl_names
...
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -sv09 ../rtl/componentes/generate_i.sv ../rtl/componentes/propagate_i.sv ../rtl/componentes/carry_output.sv ../rtl/componentes/cla4x3.sv ../rtl/componentes/cla4x3_2.sv ../rtl/somadores/clas/cla_16bits.sv
elaborate_design -golden -root {cla_16bits} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/cla_16bits/fv_map.v.gz
elaborate_design -revised -root {cla_16bits}
...
set_analyze_option -mapping_file fv/cla_16bits/fv_map.map.do
...
write_compared_points noneq.compared_points.cla_16bits.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.cla_16bits.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.cla_16bits.rtl.fv_map.rpt
