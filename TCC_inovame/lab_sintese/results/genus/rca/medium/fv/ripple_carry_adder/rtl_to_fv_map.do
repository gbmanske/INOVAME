...
# Generated on: Tue Mar 18 13:49:21 -03 2025 (Tue Mar 18 16:49:21 UTC 2025)
...
set logfile fv/ripple_carry_adder/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/ripple_carry_adder -revised fv_map -use_rtl_names
...
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -sv09 ../rtl/full_adder.sv ../rtl/ripple_carry_adder.sv
elaborate_design -golden -root {ripple_carry_adder} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/ripple_carry_adder/fv_map.v.gz
elaborate_design -revised -root {ripple_carry_adder}
...
set_analyze_option -mapping_file fv/ripple_carry_adder/fv_map.map.do
...
write_compared_points noneq.compared_points.ripple_carry_adder.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.ripple_carry_adder.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.ripple_carry_adder.rtl.fv_map.rpt
