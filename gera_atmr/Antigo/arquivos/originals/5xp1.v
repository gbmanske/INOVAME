// Benchmark "5xp1/5xp1_esp" written by ABC on Wed Oct 19 22:04:28 2022

module \5xp1/5xp1_esp  ( 
  ...
  MUX2       g15(.S(i0), .A(new_n32_), .B(new_n27_), .Y(zori0));
  ...
  NA2        g39(.A(new_n56_), .B(new_n43_), .Y(zori1));
  NO2        g40(.A(i6), .B(i1), .Y(new_n58_));
  OAI210     g41(.A0(new_n40_), .A1(new_n54_), .B0(new_n58_), .Y(new_n59_));
  NOi31      g42(.An(new_n59_), .B(new_n19_), .C(new_n34_), .Y(zori3));
  NA3        g43(.A(new_n38_), .B(i1), .C(i0), .Y(new_n61_));
  AOI210     g44(.A0(new_n61_), .A1(new_n19_), .B0(zori3), .Y(zori2));
  NO2        g45(.A(i5), .B(i2), .Y(new_n63_));
  NOi21      g46(.An(new_n22_), .B(new_n63_), .Y(zori4));
  INV        g47(.A(i2), .Y(zori5));
  NA2        g48(.A(new_n28_), .B(i2), .Y(new_n66_));
  XO2        g49(.A(zori4), .B(i6), .Y(new_n67_));
  NA2        g50(.A(new_n67_), .B(new_n66_), .Y(new_n68_));
  OAI210     g51(.A0(new_n66_), .A1(new_n24_), .B0(new_n68_), .Y(zori6));
  NA2        g52(.A(new_n54_), .B(i2), .Y(new_n70_));
  NA2        g53(.A(new_n70_), .B(i4), .Y(new_n71_));
  NA2        g54(.A(new_n71_), .B(new_n66_), .Y(zori7));
  ...
  NO3        g61(.A(i5), .B(zori5), .C(i1), .Y(new_n79_));
  ...
  OR4        g66(.A(new_n83_), .B(new_n81_), .C(new_n78_), .D(new_n76_), .Y(zori8));
  ...
  OAI220     g72(.A0(new_n89_), .A1(new_n88_), .B0(new_n87_), .B1(new_n18_), .Y(zori9));
endmodule
