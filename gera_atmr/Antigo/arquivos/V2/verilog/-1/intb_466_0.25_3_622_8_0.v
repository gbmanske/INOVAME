...
module \data/intb  ( 
  ...
  wire new_new_n23_, new_new_n24_, new_new_n25_, new_new_n26_, new_new_n27_,
    ...
    new_new_n164_, new_new_n165_, new_new_n166_, new_new_n170_,
  ...
  AN2        g042(.A(new_new_n64_), .B(new_new_n170_), .Y(new_new_n65_));
  ...
  AOI210     g084(.A0(new_new_n171_), .A1(new_new_n77_), .B0(new_new_n106_), .Y(new_new_n107_));
  ...
  OAI210     g109(.A0(x12), .A1(x01), .B0(new_new_n131_), .Y(new_new_n132_));
  ...
  AOI210     g131(.A0(new_new_n172_), .A1(x12), .B0(new_new_n26_), .Y(new_new_n154_));
  NA2        g132(.A(x12), .B(new_new_n79_), .Y(new_new_n155_));
  NOi21      g133(.An(new_new_n123_), .B(new_new_n87_), .Y(new_new_n156_));
  NO3        g134(.A(x01), .B(new_new_n155_), .C(x08), .Y(new_new_n157_));
  NO2        g135(.A(new_new_n86_), .B(new_new_n28_), .Y(new_new_n158_));
  NO2        g136(.A(new_new_n158_), .B(new_new_n114_), .Y(new_new_n159_));
  NA3        g137(.A(new_new_n127_), .B(new_new_n82_), .C(x12), .Y(new_new_n160_));
  NA2        g138(.A(new_new_n160_), .B(x08), .Y(new_new_n161_));
  INV        g139(.A(new_new_n161_), .Y(new_new_n162_));
  NO2        g140(.A(new_new_n157_), .B(new_new_n162_), .Y(new_new_n163_));
  NA2        g141(.A(new_new_n159_), .B(new_new_n156_), .Y(new_new_n164_));
  NA2        g142(.A(x14), .B(new_new_n164_), .Y(new_new_n165_));
  OAI210     g143(.A0(x07), .A1(new_new_n67_), .B0(x12), .Y(new_new_n166_));
  NO4        g144(.A(new_new_n166_), .B(new_new_n165_), .C(new_new_n163_), .D(new_new_n154_), .Y(ori06));
  INV        g145(.A(x03), .Y(new_new_n170_));
  INV        g146(.A(new_new_n93_), .Y(new_new_n171_));
  INV        g147(.A(x07), .Y(new_new_n172_));
endmodule
