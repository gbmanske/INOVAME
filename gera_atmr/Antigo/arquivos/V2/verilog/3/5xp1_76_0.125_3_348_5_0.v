...
module \data/5xp1  ( 
  ...
  wire new_new_n18_, new_new_n19_, new_new_n20_, new_new_n21_, new_new_n22_,
    ...
    new_new_n82_, new_new_n83_, new_new_n84_;
  ...
  AOI210     g31(.A0(new_new_n48_), .A1(new_new_n45_), .B0(new_new_n29_), .Y(new_new_n49_));
  NO3        g32(.A(new_new_n49_), .B(new_new_n47_), .C(new_new_n20_), .Y(new_new_n50_));
  NA2        g33(.A(new_new_n28_), .B(new_new_n26_), .Y(new_new_n51_));
  NO2        g34(.A(new_new_n51_), .B(new_new_n20_), .Y(new_new_n52_));
  NO2        g35(.A(i_1_), .B(i_6_), .Y(new_new_n53_));
  AN2        g36(.A(new_new_n53_), .B(new_new_n31_), .Y(new_new_n54_));
  NO2        g37(.A(new_new_n52_), .B(new_new_n54_), .Y(new_new_n55_));
  OAI210     g38(.A0(new_new_n50_), .A1(new_new_n44_), .B0(new_new_n55_), .Y(ori02));
  NAi21      g39(.An(new_new_n21_), .B(new_new_n41_), .Y(new_new_n57_));
  NA3        g40(.A(i_2_), .B(i_1_), .C(i_3_), .Y(new_new_n58_));
  NO2        g41(.A(new_new_n52_), .B(new_new_n31_), .Y(new_new_n59_));
  NA2        g42(.A(new_new_n59_), .B(new_new_n57_), .Y(ori00));
  NA2        g43(.A(new_new_n51_), .B(i_5_), .Y(new_new_n61_));
  NO2        g44(.A(new_new_n61_), .B(new_new_n20_), .Y(ori09));
  NOi21      g45(.An(new_new_n36_), .B(new_new_n32_), .Y(ori07));
  INV        g46(.A(i_3_), .Y(ori08));
  INV        g47(.A(new_new_n29_), .Y(new_new_n65_));
  NA2        g48(.A(ori07), .B(new_new_n65_), .Y(new_new_n66_));
  XO2        g49(.A(new_new_n66_), .B(new_new_n28_), .Y(ori05));
  NO2        g50(.A(i_2_), .B(ori08), .Y(new_new_n68_));
  XO2        g51(.A(new_new_n68_), .B(i_1_), .Y(ori06));
  NO2        g52(.A(i_1_), .B(i_6_), .Y(new_new_n70_));
  NO3        g53(.A(new_new_n70_), .B(new_new_n40_), .C(new_new_n36_), .Y(new_new_n71_));
  NO2        g54(.A(new_new_n71_), .B(new_new_n37_), .Y(new_new_n72_));
  ...
  NO2        g57(.A(new_new_n74_), .B(new_new_n46_), .Y(new_new_n75_));
  INV        g58(.A(new_new_n75_), .Y(new_new_n76_));
  NA3        g59(.A(new_new_n76_), .B(new_new_n73_), .C(new_new_n72_), .Y(ori03));
  NA2        g60(.A(new_new_n28_), .B(ori08), .Y(new_new_n78_));
  OAI210     g61(.A0(new_new_n78_), .A1(i_1_), .B0(new_new_n58_), .Y(new_new_n79_));
  OAI210     g62(.A0(new_new_n79_), .A1(new_new_n33_), .B0(i_6_), .Y(new_new_n80_));
  AOI210     g63(.A0(new_new_n32_), .A1(new_new_n26_), .B0(new_new_n29_), .Y(new_new_n81_));
  OR2        g64(.A(new_new_n81_), .B(new_new_n70_), .Y(new_new_n82_));
  NA3        g65(.A(new_new_n78_), .B(new_new_n70_), .C(i_2_), .Y(new_new_n83_));
  NA3        g66(.A(new_new_n23_), .B(i_1_), .C(new_new_n26_), .Y(new_new_n84_));
  NA4        g67(.A(new_new_n84_), .B(new_new_n83_), .C(new_new_n82_), .D(new_new_n80_), .Y(ori04));
endmodule
