...
module \data/5xp1  ( 
  ...
  wire new_new_n18_, new_new_n19_, new_new_n20_, new_new_n21_, new_new_n22_,
    ...
    new_new_n87_, new_new_n88_, new_new_n89_;
  ...
  NO2        g38(.A(new_new_n53_), .B(new_new_n55_), .Y(new_new_n56_));
  OAI210     g39(.A0(new_new_n51_), .A1(new_new_n45_), .B0(new_new_n56_), .Y(ori02));
  NAi21      g40(.An(new_new_n21_), .B(new_new_n41_), .Y(new_new_n58_));
  ...
  INV        g53(.A(new_new_n43_), .Y(new_new_n71_));
  NA2        g54(.A(new_new_n71_), .B(i_0_), .Y(new_new_n72_));
  NO2        g55(.A(i_1_), .B(i_6_), .Y(new_new_n73_));
  NO3        g56(.A(new_new_n73_), .B(new_new_n40_), .C(new_new_n36_), .Y(new_new_n74_));
  NO2        g57(.A(new_new_n74_), .B(new_new_n37_), .Y(new_new_n75_));
  AO210      g58(.A0(new_new_n39_), .A1(new_new_n24_), .B0(new_new_n18_), .Y(new_new_n76_));
  ...
  NO2        g62(.A(new_new_n79_), .B(new_new_n47_), .Y(new_new_n80_));
  AOI210     g63(.A0(new_new_n78_), .A1(new_new_n77_), .B0(new_new_n80_), .Y(new_new_n81_));
  NA4        g64(.A(new_new_n81_), .B(new_new_n76_), .C(new_new_n75_), .D(new_new_n72_), .Y(ori03));
  NA2        g65(.A(new_new_n28_), .B(ori08), .Y(new_new_n83_));
  OAI210     g66(.A0(new_new_n83_), .A1(i_1_), .B0(new_new_n59_), .Y(new_new_n84_));
  ...
  NA4        g72(.A(new_new_n89_), .B(new_new_n88_), .C(new_new_n87_), .D(new_new_n85_), .Y(ori04));
endmodule
