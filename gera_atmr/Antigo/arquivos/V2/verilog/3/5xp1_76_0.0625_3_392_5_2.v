...
module \data/5xp1  ( 
  ...
  OR3        g21(.A(new_new_n34_), .B(new_new_n25_), .C(new_new_n19_), .Y(men01));
  ...
  OAI210     g40(.A0(new_new_n54_), .A1(new_new_n47_), .B0(new_new_n57_), .Y(men02));
  ...
  NA4        g65(.A(new_new_n82_), .B(new_new_n77_), .C(new_new_n76_), .D(new_new_n73_), .Y(men03));
  NA2        g66(.A(new_new_n28_), .B(men08), .Y(new_new_n84_));
  ...
  NA4        g73(.A(new_new_n90_), .B(new_new_n89_), .C(new_new_n88_), .D(new_new_n86_), .Y(men04));
endmodule
