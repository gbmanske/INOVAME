...
module \data/5xp1  ( 
  ...
  OAI210     g40(.A0(new_new_n52_), .A1(new_new_n46_), .B0(new_new_n57_), .Y(mai02));
  ...
  NA4        g64(.A(new_new_n81_), .B(new_new_n76_), .C(new_new_n75_), .D(new_new_n72_), .Y(mai03));
  NA2        g65(.A(new_new_n28_), .B(mai08), .Y(new_new_n83_));
  ...
  NA4        g72(.A(new_new_n89_), .B(new_new_n88_), .C(new_new_n87_), .D(new_new_n85_), .Y(mai04));
