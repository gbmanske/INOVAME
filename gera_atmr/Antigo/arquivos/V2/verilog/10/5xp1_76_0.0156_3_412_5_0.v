...
module \data/5xp1  ( 
  ...
  OR4        g21(.A(new_new_n38_), .B(new_new_n34_), .C(new_new_n25_), .D(new_new_n19_), .Y(ori01));
  ...
  NO3        g36(.A(new_new_n52_), .B(new_new_n50_), .C(new_new_n20_), .Y(new_new_n54_));
  ...
  OAI210     g42(.A0(new_new_n54_), .A1(new_new_n47_), .B0(new_new_n59_), .Y(ori02));
  NAi21      g43(.An(new_new_n21_), .B(new_new_n43_), .Y(new_new_n61_));
  NA3        g44(.A(i_2_), .B(i_1_), .C(i_3_), .Y(new_new_n62_));
  AOI210     g45(.A0(new_new_n56_), .A1(new_new_n62_), .B0(new_new_n31_), .Y(new_new_n63_));
  NA2        g46(.A(new_new_n63_), .B(new_new_n61_), .Y(ori00));
  OAI210     g47(.A0(new_new_n55_), .A1(new_new_n37_), .B0(i_5_), .Y(new_new_n65_));
  NO2        g48(.A(new_new_n65_), .B(new_new_n20_), .Y(ori09));
  NOi21      g49(.An(new_new_n36_), .B(new_new_n32_), .Y(ori07));
  INV        g50(.A(i_3_), .Y(ori08));
  INV        g51(.A(new_new_n29_), .Y(new_new_n69_));
  NA2        g52(.A(ori07), .B(new_new_n69_), .Y(new_new_n70_));
  XO2        g53(.A(new_new_n70_), .B(new_new_n28_), .Y(ori05));
  NO2        g54(.A(i_2_), .B(ori08), .Y(new_new_n72_));
  XO2        g55(.A(new_new_n72_), .B(i_1_), .Y(ori06));
  ...
  NA4        g67(.A(new_new_n84_), .B(new_new_n79_), .C(new_new_n78_), .D(new_new_n75_), .Y(ori03));
  NA2        g68(.A(new_new_n28_), .B(ori08), .Y(new_new_n86_));
  ...
  NA4        g75(.A(new_new_n92_), .B(new_new_n91_), .C(new_new_n90_), .D(new_new_n88_), .Y(ori04));
endmodule
