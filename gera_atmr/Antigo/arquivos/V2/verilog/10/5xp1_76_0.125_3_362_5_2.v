...
module \data/5xp1  ( 
  ...
  OAI210     g35(.A0(new_new_n47_), .A1(new_new_n43_), .B0(new_new_n52_), .Y(men02));
  ...
  NA4        g59(.A(new_new_n76_), .B(new_new_n71_), .C(new_new_n70_), .D(new_new_n67_), .Y(men03));
  NA2        g60(.A(new_new_n26_), .B(men08), .Y(new_new_n78_));
  ...
  NA4        g67(.A(new_new_n84_), .B(new_new_n83_), .C(new_new_n82_), .D(new_new_n80_), .Y(men04));
