...
module \data/5xp1  ( 
  ...
  OR4        g20(.A(new_new_n37_), .B(new_new_n34_), .C(new_new_n25_), .D(new_new_n19_), .Y(mai01));
  ...
  AOI210     g23(.A0(new_new_n40_), .A1(new_new_n39_), .B0(new_new_n26_), .Y(new_new_n41_));
  NA2        g24(.A(new_new_n29_), .B(new_new_n18_), .Y(new_new_n42_));
  OAI220     g25(.A0(new_new_n42_), .A1(new_new_n26_), .B0(new_new_n35_), .B1(new_new_n28_), .Y(new_new_n43_));
  ...
  NO2        g32(.A(i_6_), .B(i_5_), .Y(new_new_n50_));
  ...
  NAi21      g38(.An(new_new_n21_), .B(new_new_n40_), .Y(new_new_n56_));
  ...
  NO3        g54(.A(new_new_n71_), .B(new_new_n39_), .C(new_new_n36_), .Y(new_new_n72_));
  NO2        g55(.A(new_new_n72_), .B(new_new_n37_), .Y(new_new_n73_));
  OR2        g56(.A(new_new_n24_), .B(new_new_n18_), .Y(new_new_n74_));
  ...
  NA2        g63(.A(new_new_n28_), .B(mai08), .Y(new_new_n81_));
  ...
  NO2        g66(.A(new_new_n26_), .B(new_new_n29_), .Y(new_new_n84_));
  OR2        g67(.A(new_new_n84_), .B(new_new_n71_), .Y(new_new_n85_));
  NA3        g68(.A(new_new_n81_), .B(new_new_n71_), .C(i_2_), .Y(new_new_n86_));
  NA3        g69(.A(new_new_n86_), .B(new_new_n85_), .C(new_new_n83_), .Y(mai04));
endmodule
