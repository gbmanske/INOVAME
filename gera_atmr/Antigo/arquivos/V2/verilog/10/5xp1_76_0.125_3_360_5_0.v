...
module \data/5xp1  ( 
  ...
  OR3        g21(.A(new_new_n34_), .B(new_new_n25_), .C(new_new_n19_), .Y(ori01));
  NA2        g22(.A(i_0_), .B(i_1_), .Y(new_new_n40_));
  ...
  AO220      g36(.A0(new_new_n53_), .A1(new_new_n31_), .B0(new_new_n37_), .B1(new_new_n19_), .Y(new_new_n54_));
  INV        g37(.A(new_new_n54_), .Y(new_new_n55_));
  OAI210     g38(.A0(new_new_n52_), .A1(new_new_n46_), .B0(new_new_n55_), .Y(ori02));
  NAi21      g39(.An(new_new_n21_), .B(new_new_n42_), .Y(new_new_n57_));
  ...
  INV        g52(.A(new_new_n44_), .Y(new_new_n70_));
  NA2        g53(.A(new_new_n70_), .B(i_0_), .Y(new_new_n71_));
  NO2        g54(.A(i_1_), .B(i_6_), .Y(new_new_n72_));
  NO3        g55(.A(new_new_n72_), .B(new_new_n41_), .C(new_new_n36_), .Y(new_new_n73_));
  NO2        g56(.A(new_new_n73_), .B(new_new_n38_), .Y(new_new_n74_));
  AO210      g57(.A0(new_new_n40_), .A1(new_new_n24_), .B0(new_new_n18_), .Y(new_new_n75_));
  OAI210     g58(.A0(new_new_n22_), .A1(i_6_), .B0(new_new_n18_), .Y(new_new_n76_));
  NO2        g59(.A(new_new_n76_), .B(new_new_n48_), .Y(new_new_n77_));
  INV        g60(.A(new_new_n77_), .Y(new_new_n78_));
  NA4        g61(.A(new_new_n78_), .B(new_new_n75_), .C(new_new_n74_), .D(new_new_n71_), .Y(ori03));
  NA2        g62(.A(new_new_n28_), .B(ori08), .Y(new_new_n80_));
  ...
  NA4        g69(.A(new_new_n86_), .B(new_new_n85_), .C(new_new_n84_), .D(new_new_n82_), .Y(ori04));
endmodule
