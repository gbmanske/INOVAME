...
module \data/5xp1  ( 
  ...
  NO2        g61(.A(new_new_n78_), .B(new_new_n48_), .Y(new_new_n79_));
  INV        g62(.A(new_new_n79_), .Y(new_new_n80_));
  NA4        g63(.A(new_new_n80_), .B(new_new_n77_), .C(new_new_n76_), .D(new_new_n73_), .Y(ori03));
  NA2        g64(.A(new_new_n28_), .B(ori08), .Y(new_new_n82_));
  OAI210     g65(.A0(new_new_n82_), .A1(i_1_), .B0(new_new_n60_), .Y(new_new_n83_));
  OAI210     g66(.A0(new_new_n83_), .A1(new_new_n33_), .B0(i_6_), .Y(new_new_n84_));
  AOI210     g67(.A0(new_new_n32_), .A1(new_new_n26_), .B0(new_new_n29_), .Y(new_new_n85_));
  OR2        g68(.A(new_new_n85_), .B(new_new_n74_), .Y(new_new_n86_));
  NA3        g69(.A(new_new_n82_), .B(new_new_n74_), .C(i_2_), .Y(new_new_n87_));
  NA3        g70(.A(new_new_n23_), .B(i_1_), .C(new_new_n26_), .Y(new_new_n88_));
  NA4        g71(.A(new_new_n88_), .B(new_new_n87_), .C(new_new_n86_), .D(new_new_n84_), .Y(ori04));
endmodule
