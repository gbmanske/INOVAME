...
module \data/5xp1  ( 
  ...
  OR3        g19(.A(new_new_n36_), .B(new_new_n33_), .C(new_new_n19_), .Y(mai01));
  OR2        g20(.A(i_2_), .B(i_3_), .Y(new_new_n38_));
  NA3        g21(.A(new_new_n38_), .B(i_0_), .C(i_1_), .Y(new_new_n39_));
  NA2        g22(.A(new_new_n27_), .B(new_new_n18_), .Y(new_new_n40_));
  AOI220     g23(.A0(i_6_), .A1(new_new_n40_), .B0(new_new_n39_), .B1(new_new_n25_), .Y(new_new_n41_));
  NA2        g24(.A(new_new_n28_), .B(new_new_n18_), .Y(new_new_n42_));
  OAI220     g25(.A0(new_new_n42_), .A1(new_new_n25_), .B0(new_new_n34_), .B1(new_new_n27_), .Y(new_new_n43_));
  ...
  NOi31      g29(.An(new_new_n46_), .B(new_new_n23_), .C(new_new_n18_), .Y(new_new_n47_));
  NA3        g30(.A(i_1_), .B(i_6_), .C(i_5_), .Y(new_new_n48_));
  AOI210     g31(.A0(new_new_n48_), .A1(new_new_n45_), .B0(new_new_n28_), .Y(new_new_n49_));
  ...
  NA2        g34(.A(new_new_n27_), .B(new_new_n25_), .Y(new_new_n52_));
  NO2        g35(.A(new_new_n52_), .B(new_new_n20_), .Y(new_new_n53_));
  INV        g36(.A(new_new_n53_), .Y(new_new_n54_));
  OAI210     g37(.A0(new_new_n51_), .A1(new_new_n44_), .B0(new_new_n54_), .Y(mai02));
  NAi21      g38(.An(new_new_n21_), .B(i_6_), .Y(new_new_n56_));
  NA3        g39(.A(i_2_), .B(i_1_), .C(i_3_), .Y(new_new_n57_));
  NO2        g40(.A(new_new_n53_), .B(new_new_n30_), .Y(new_new_n58_));
  NA2        g41(.A(new_new_n58_), .B(new_new_n56_), .Y(mai00));
  NA2        g42(.A(new_new_n52_), .B(i_5_), .Y(new_new_n60_));
  NO2        g43(.A(new_new_n60_), .B(new_new_n20_), .Y(mai09));
  NOi21      g44(.An(new_new_n35_), .B(new_new_n31_), .Y(mai07));
  INV        g45(.A(i_3_), .Y(mai08));
  INV        g46(.A(new_new_n28_), .Y(new_new_n64_));
  NA2        g47(.A(mai07), .B(new_new_n64_), .Y(new_new_n65_));
  XO2        g48(.A(new_new_n65_), .B(new_new_n27_), .Y(mai05));
  NO2        g49(.A(i_2_), .B(mai08), .Y(new_new_n67_));
  XO2        g50(.A(new_new_n67_), .B(i_1_), .Y(mai06));
  NAi21      g51(.An(new_new_n50_), .B(new_new_n42_), .Y(new_new_n69_));
  NA2        g52(.A(new_new_n69_), .B(i_0_), .Y(new_new_n70_));
  NO2        g53(.A(i_1_), .B(i_6_), .Y(new_new_n71_));
  NO3        g54(.A(new_new_n71_), .B(new_new_n40_), .C(new_new_n35_), .Y(new_new_n72_));
  ...
  NO2        g57(.A(new_new_n28_), .B(new_new_n27_), .Y(new_new_n75_));
  NO2        g58(.A(new_new_n25_), .B(new_new_n18_), .Y(new_new_n76_));
  ...
  NA4        g62(.A(new_new_n79_), .B(new_new_n74_), .C(new_new_n73_), .D(new_new_n70_), .Y(mai03));
  NA2        g63(.A(new_new_n27_), .B(mai08), .Y(new_new_n81_));
  OAI210     g64(.A0(new_new_n81_), .A1(i_1_), .B0(new_new_n57_), .Y(new_new_n82_));
  OAI210     g65(.A0(new_new_n82_), .A1(new_new_n32_), .B0(i_6_), .Y(new_new_n83_));
  AOI210     g66(.A0(new_new_n31_), .A1(new_new_n25_), .B0(new_new_n28_), .Y(new_new_n84_));
  OR2        g67(.A(new_new_n84_), .B(new_new_n71_), .Y(new_new_n85_));
  NA3        g68(.A(new_new_n81_), .B(new_new_n71_), .C(i_2_), .Y(new_new_n86_));
  NA3        g69(.A(new_new_n23_), .B(i_1_), .C(new_new_n25_), .Y(new_new_n87_));
  NA4        g70(.A(new_new_n87_), .B(new_new_n86_), .C(new_new_n85_), .D(new_new_n83_), .Y(mai04));
endmodule
