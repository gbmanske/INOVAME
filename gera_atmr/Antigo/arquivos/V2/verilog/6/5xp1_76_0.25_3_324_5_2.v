...
module \data/5xp1  ( 
  ...
  NA2        g21(.A(new_new_n26_), .B(new_new_n18_), .Y(new_new_n39_));
  OAI220     g22(.A0(new_new_n39_), .A1(new_new_n23_), .B0(new_new_n32_), .B1(new_new_n25_), .Y(new_new_n40_));
  ...
  AOI210     g27(.A0(new_new_n44_), .A1(new_new_n42_), .B0(new_new_n26_), .Y(new_new_n45_));
  NO2        g28(.A(i_6_), .B(i_5_), .Y(new_new_n46_));
  NO3        g29(.A(new_new_n46_), .B(new_new_n45_), .C(new_new_n20_), .Y(new_new_n47_));
  NA2        g30(.A(new_new_n25_), .B(new_new_n23_), .Y(new_new_n48_));
  NO2        g31(.A(new_new_n48_), .B(new_new_n20_), .Y(new_new_n49_));
  AN2        g32(.A(new_new_n34_), .B(new_new_n19_), .Y(new_new_n50_));
  AOI210     g33(.A0(new_new_n49_), .A1(new_new_n33_), .B0(new_new_n50_), .Y(new_new_n51_));
  OAI210     g34(.A0(new_new_n47_), .A1(new_new_n41_), .B0(new_new_n51_), .Y(men02));
  NAi21      g35(.An(new_new_n21_), .B(i_6_), .Y(new_new_n53_));
  NA3        g36(.A(i_2_), .B(i_1_), .C(i_3_), .Y(new_new_n54_));
  AOI210     g37(.A0(new_new_n49_), .A1(new_new_n54_), .B0(new_new_n28_), .Y(new_new_n55_));
  NA2        g38(.A(new_new_n55_), .B(new_new_n53_), .Y(men00));
  OAI210     g39(.A0(new_new_n48_), .A1(new_new_n34_), .B0(i_5_), .Y(new_new_n57_));
  NO2        g40(.A(new_new_n57_), .B(new_new_n20_), .Y(men09));
  NOi21      g41(.An(new_new_n33_), .B(new_new_n29_), .Y(men07));
  INV        g42(.A(i_3_), .Y(men08));
  INV        g43(.A(new_new_n26_), .Y(new_new_n61_));
  NA2        g44(.A(men07), .B(new_new_n61_), .Y(new_new_n62_));
  XO2        g45(.A(new_new_n62_), .B(new_new_n25_), .Y(men05));
  NO2        g46(.A(i_2_), .B(men08), .Y(new_new_n64_));
  XO2        g47(.A(new_new_n64_), .B(i_1_), .Y(men06));
  NAi21      g48(.An(new_new_n46_), .B(new_new_n39_), .Y(new_new_n66_));
  NA2        g49(.A(new_new_n66_), .B(i_0_), .Y(new_new_n67_));
  NO2        g50(.A(i_1_), .B(i_6_), .Y(new_new_n68_));
  NO3        g51(.A(new_new_n68_), .B(new_new_n37_), .C(new_new_n33_), .Y(new_new_n69_));
  NO2        g52(.A(new_new_n69_), .B(new_new_n35_), .Y(new_new_n70_));
  NO2        g53(.A(new_new_n23_), .B(new_new_n18_), .Y(new_new_n71_));
  OAI210     g54(.A0(new_new_n22_), .A1(i_6_), .B0(new_new_n18_), .Y(new_new_n72_));
  NO2        g55(.A(new_new_n72_), .B(new_new_n43_), .Y(new_new_n73_));
  AOI210     g56(.A0(new_new_n71_), .A1(i_0_), .B0(new_new_n73_), .Y(new_new_n74_));
  NA3        g57(.A(new_new_n74_), .B(new_new_n70_), .C(new_new_n67_), .Y(men03));
  NA2        g58(.A(new_new_n25_), .B(men08), .Y(new_new_n76_));
  INV        g59(.A(new_new_n54_), .Y(new_new_n77_));
  OAI210     g60(.A0(new_new_n77_), .A1(new_new_n30_), .B0(i_6_), .Y(new_new_n78_));
  NO2        g61(.A(new_new_n23_), .B(new_new_n26_), .Y(new_new_n79_));
  OR2        g62(.A(new_new_n79_), .B(new_new_n68_), .Y(new_new_n80_));
  NA3        g63(.A(new_new_n76_), .B(new_new_n68_), .C(i_2_), .Y(new_new_n81_));
  NA3        g64(.A(new_new_n81_), .B(new_new_n80_), .C(new_new_n78_), .Y(men04));
endmodule
