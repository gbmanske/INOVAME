...
module \data/5xp1  ( 
  ...
  NOi21      g28(.An(i_6_), .B(new_new_n18_), .Y(new_new_n46_));
  NO2        g29(.A(new_new_n45_), .B(new_new_n29_), .Y(new_new_n47_));
  NO3        g30(.A(new_new_n47_), .B(new_new_n46_), .C(new_new_n20_), .Y(new_new_n48_));
  ...
  OAI210     g34(.A0(new_new_n48_), .A1(new_new_n44_), .B0(new_new_n51_), .Y(ori02));
  ...
  NO3        g49(.A(new_new_n66_), .B(new_new_n40_), .C(new_new_n36_), .Y(new_new_n67_));
  NO2        g50(.A(new_new_n67_), .B(new_new_n37_), .Y(new_new_n68_));
  AO210      g51(.A0(new_new_n39_), .A1(new_new_n24_), .B0(new_new_n18_), .Y(new_new_n69_));
  NA2        g52(.A(new_new_n69_), .B(new_new_n68_), .Y(ori03));
  NA2        g53(.A(new_new_n28_), .B(ori08), .Y(new_new_n71_));
  OAI210     g54(.A0(new_new_n71_), .A1(i_1_), .B0(new_new_n54_), .Y(new_new_n72_));
  OAI210     g55(.A0(new_new_n72_), .A1(new_new_n33_), .B0(i_6_), .Y(new_new_n73_));
  INV        g56(.A(new_new_n29_), .Y(new_new_n74_));
  OR2        g57(.A(new_new_n74_), .B(new_new_n66_), .Y(new_new_n75_));
  NA3        g58(.A(new_new_n71_), .B(new_new_n66_), .C(i_2_), .Y(new_new_n76_));
  NA3        g59(.A(new_new_n23_), .B(i_1_), .C(new_new_n26_), .Y(new_new_n77_));
  NA4        g60(.A(new_new_n77_), .B(new_new_n76_), .C(new_new_n75_), .D(new_new_n73_), .Y(ori04));
endmodule
