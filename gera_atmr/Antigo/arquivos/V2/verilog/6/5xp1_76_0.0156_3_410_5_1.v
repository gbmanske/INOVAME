...
module \data/5xp1  ( 
  ...
  NO2        g41(.A(new_new_n56_), .B(new_new_n58_), .Y(new_new_n59_));
  OAI210     g42(.A0(new_new_n54_), .A1(new_new_n47_), .B0(new_new_n59_), .Y(mai02));
  ...
  NA2        g46(.A(new_new_n63_), .B(new_new_n61_), .Y(mai00));
  NA2        g47(.A(new_new_n55_), .B(i_5_), .Y(new_new_n65_));
  NO2        g48(.A(new_new_n65_), .B(new_new_n20_), .Y(mai09));
  NOi21      g49(.An(new_new_n36_), .B(new_new_n32_), .Y(mai07));
  INV        g50(.A(i_3_), .Y(mai08));
  INV        g51(.A(new_new_n29_), .Y(new_new_n69_));
  NA2        g52(.A(mai07), .B(new_new_n69_), .Y(new_new_n70_));
  XO2        g53(.A(new_new_n70_), .B(new_new_n28_), .Y(mai05));
  NO2        g54(.A(i_2_), .B(mai08), .Y(new_new_n72_));
  XO2        g55(.A(new_new_n72_), .B(i_1_), .Y(mai06));
  ...
  NA4        g67(.A(new_new_n84_), .B(new_new_n79_), .C(new_new_n78_), .D(new_new_n75_), .Y(mai03));
  NA2        g68(.A(new_new_n28_), .B(mai08), .Y(new_new_n86_));
  ...
  NA4        g75(.A(new_new_n92_), .B(new_new_n91_), .C(new_new_n90_), .D(new_new_n88_), .Y(mai04));
endmodule
