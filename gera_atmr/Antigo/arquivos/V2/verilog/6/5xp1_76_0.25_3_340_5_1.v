...
module \data/5xp1  ( 
  ...
  OR3        g17(.A(new_new_n33_), .B(new_new_n25_), .C(new_new_n19_), .Y(mai01));
  ...
  NA2        g38(.A(new_new_n55_), .B(new_new_n54_), .Y(mai00));
  INV        g39(.A(i_5_), .Y(new_new_n57_));
  NO2        g40(.A(new_new_n57_), .B(new_new_n20_), .Y(mai09));
  NOi21      g41(.An(new_new_n34_), .B(new_new_n31_), .Y(mai07));
  INV        g42(.A(i_3_), .Y(mai08));
  INV        g43(.A(new_new_n29_), .Y(new_new_n61_));
  NA2        g44(.A(mai07), .B(new_new_n61_), .Y(new_new_n62_));
  XO2        g45(.A(new_new_n62_), .B(new_new_n28_), .Y(mai05));
  NO2        g46(.A(i_2_), .B(mai08), .Y(new_new_n64_));
  XO2        g47(.A(new_new_n64_), .B(i_1_), .Y(mai06));
  ...
  NA3        g57(.A(new_new_n74_), .B(new_new_n69_), .C(new_new_n67_), .Y(mai03));
  NA2        g58(.A(new_new_n28_), .B(mai08), .Y(new_new_n76_));
  ...
  NA4        g65(.A(new_new_n82_), .B(new_new_n81_), .C(new_new_n80_), .D(new_new_n78_), .Y(mai04));
endmodule
