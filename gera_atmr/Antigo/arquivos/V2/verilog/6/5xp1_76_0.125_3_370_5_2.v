...
module \data/5xp1  ( 
  ...
  OR3        g19(.A(new_new_n34_), .B(new_new_n25_), .C(new_new_n19_), .Y(men01));
  ...
  OAI210     g38(.A0(new_new_n52_), .A1(new_new_n45_), .B0(new_new_n55_), .Y(men02));
  ...
  NOi21      g45(.An(new_new_n36_), .B(new_new_n32_), .Y(men07));
  ...
  NA3        g61(.A(new_new_n78_), .B(new_new_n73_), .C(new_new_n71_), .Y(men03));
  ...
  NA4        g69(.A(new_new_n86_), .B(new_new_n85_), .C(new_new_n84_), .D(new_new_n82_), .Y(men04));
endmodule
