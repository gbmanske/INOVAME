...
module \data/intb  ( 
  ...
  wire new_new_n23_, new_new_n24_, new_new_n25_, new_new_n26_, new_new_n27_,
    ...
    new_new_n75_, new_new_n77_, new_new_n78_, new_new_n79_, new_new_n80_,
    new_new_n81_, new_new_n82_, new_new_n84_, new_new_n85_, new_new_n86_,
    new_new_n88_, new_new_n92_;
  ...
  NO2        g48(.A(new_new_n49_), .B(x03), .Y(new_new_n71_));
  NA2        g49(.A(x13), .B(new_new_n63_), .Y(new_new_n72_));
  INV        g50(.A(new_new_n59_), .Y(new_new_n73_));
  NO2        g51(.A(new_new_n73_), .B(x07), .Y(new_new_n74_));
  INV        g52(.A(new_new_n74_), .Y(new_new_n75_));
  OAI210     g53(.A0(new_new_n92_), .A1(new_new_n52_), .B0(new_new_n75_), .Y(ori02));
  INV        g54(.A(new_new_n66_), .Y(new_new_n77_));
  NA2        g55(.A(new_new_n77_), .B(new_new_n48_), .Y(new_new_n78_));
  NO2        g56(.A(new_new_n69_), .B(new_new_n50_), .Y(new_new_n79_));
  INV        g57(.A(new_new_n79_), .Y(new_new_n80_));
  NA2        g58(.A(new_new_n80_), .B(x06), .Y(new_new_n81_));
  NA2        g59(.A(new_new_n81_), .B(new_new_n78_), .Y(new_new_n82_));
  INV        g60(.A(new_new_n82_), .Y(ori03));
  OR2        g61(.A(new_new_n42_), .B(new_new_n71_), .Y(new_new_n84_));
  AOI210     g62(.A0(new_new_n35_), .A1(new_new_n63_), .B0(new_new_n84_), .Y(new_new_n85_));
  NA2        g63(.A(new_new_n85_), .B(x05), .Y(new_new_n86_));
  NA2        g64(.A(new_new_n68_), .B(new_new_n86_), .Y(ori04));
  NO2        g65(.A(new_new_n56_), .B(new_new_n39_), .Y(new_new_n88_));
  XO2        g66(.A(new_new_n88_), .B(new_new_n72_), .Y(ori05));
  INV        g67(.A(new_new_n70_), .Y(new_new_n92_));
  ZERO       g68(.Y(ori06));
endmodule
