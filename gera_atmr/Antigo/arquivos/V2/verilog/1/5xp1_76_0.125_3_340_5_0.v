...
module \data/5xp1  ( 
  ...
  NO2        g29(.A(new_new_n87_), .B(new_new_n20_), .Y(new_new_n47_));
  NA2        g30(.A(new_new_n28_), .B(new_new_n26_), .Y(new_new_n48_));
  NO2        g31(.A(new_new_n48_), .B(new_new_n20_), .Y(new_new_n49_));
  NO2        g32(.A(i_1_), .B(i_6_), .Y(new_new_n50_));
  AN2        g33(.A(new_new_n50_), .B(new_new_n31_), .Y(new_new_n51_));
  NO2        g34(.A(new_new_n49_), .B(new_new_n51_), .Y(new_new_n52_));
  OAI210     g35(.A0(new_new_n47_), .A1(new_new_n44_), .B0(new_new_n52_), .Y(ori02));
  NAi21      g36(.An(new_new_n21_), .B(new_new_n41_), .Y(new_new_n54_));
  NA3        g37(.A(i_2_), .B(i_1_), .C(i_3_), .Y(new_new_n55_));
  NO2        g38(.A(new_new_n49_), .B(new_new_n31_), .Y(new_new_n56_));
  NA2        g39(.A(new_new_n56_), .B(new_new_n54_), .Y(ori00));
  NA2        g40(.A(new_new_n48_), .B(i_5_), .Y(new_new_n58_));
  NO2        g41(.A(new_new_n58_), .B(new_new_n20_), .Y(ori09));
  NOi21      g42(.An(new_new_n36_), .B(new_new_n32_), .Y(ori07));
  INV        g43(.A(i_3_), .Y(ori08));
  INV        g44(.A(new_new_n29_), .Y(new_new_n62_));
  NA2        g45(.A(ori07), .B(new_new_n62_), .Y(new_new_n63_));
  XO2        g46(.A(new_new_n63_), .B(new_new_n28_), .Y(ori05));
  NO2        g47(.A(i_2_), .B(ori08), .Y(new_new_n65_));
  XO2        g48(.A(new_new_n65_), .B(i_1_), .Y(ori06));
  NO2        g49(.A(i_1_), .B(i_6_), .Y(new_new_n67_));
  NO3        g50(.A(new_new_n67_), .B(new_new_n40_), .C(new_new_n36_), .Y(new_new_n68_));
  NO2        g51(.A(new_new_n68_), .B(new_new_n37_), .Y(new_new_n69_));
  AO210      g52(.A0(new_new_n39_), .A1(new_new_n24_), .B0(new_new_n18_), .Y(new_new_n70_));
  ...
  NA3        g58(.A(new_new_n75_), .B(new_new_n70_), .C(new_new_n69_), .Y(ori03));
  ...
  OR2        g63(.A(new_new_n80_), .B(new_new_n67_), .Y(new_new_n81_));
  NA3        g64(.A(new_new_n77_), .B(new_new_n67_), .C(i_2_), .Y(new_new_n82_));
