...
module \data/5xp1  ( 
  ...
  OAI220     g27(.A0(new_new_n44_), .A1(new_new_n26_), .B0(new_new_n34_), .B1(new_new_n28_), .Y(new_new_n45_));
  NO3        g28(.A(new_new_n45_), .B(new_new_n43_), .C(i_4_), .Y(new_new_n46_));
  NA2        g29(.A(i_0_), .B(i_6_), .Y(new_new_n47_));
  NOi31      g30(.An(i_6_), .B(new_new_n23_), .C(new_new_n18_), .Y(new_new_n48_));
  NA3        g31(.A(i_1_), .B(i_6_), .C(i_5_), .Y(new_new_n49_));
  AOI210     g32(.A0(new_new_n49_), .A1(new_new_n47_), .B0(new_new_n29_), .Y(new_new_n50_));
  NO3        g33(.A(new_new_n39_), .B(i_6_), .C(i_5_), .Y(new_new_n51_));
  ...
  AO220      g38(.A0(new_new_n55_), .A1(new_new_n30_), .B0(new_new_n36_), .B1(new_new_n19_), .Y(new_new_n56_));
  AOI210     g39(.A0(new_new_n54_), .A1(new_new_n35_), .B0(new_new_n56_), .Y(new_new_n57_));
  ...
  AOI210     g43(.A0(new_new_n54_), .A1(new_new_n60_), .B0(new_new_n30_), .Y(new_new_n61_));
  NA2        g44(.A(new_new_n61_), .B(new_new_n59_), .Y(men00));
  OAI210     g45(.A0(new_new_n53_), .A1(new_new_n36_), .B0(i_5_), .Y(new_new_n63_));
  NO2        g46(.A(new_new_n63_), .B(new_new_n20_), .Y(men09));
  NOi21      g47(.An(new_new_n35_), .B(new_new_n31_), .Y(men07));
  ...
  NAi21      g54(.An(new_new_n51_), .B(new_new_n44_), .Y(new_new_n72_));
  NA2        g55(.A(new_new_n72_), .B(i_0_), .Y(new_new_n73_));
  NO2        g56(.A(i_1_), .B(i_6_), .Y(new_new_n74_));
  NO3        g57(.A(new_new_n74_), .B(new_new_n41_), .C(new_new_n35_), .Y(new_new_n75_));
  ...
  NA2        g61(.A(new_new_n78_), .B(i_0_), .Y(new_new_n79_));
  NA4        g62(.A(new_new_n79_), .B(new_new_n77_), .C(new_new_n76_), .D(new_new_n73_), .Y(men03));
  INV        g63(.A(new_new_n60_), .Y(new_new_n81_));
  OAI210     g64(.A0(new_new_n81_), .A1(new_new_n32_), .B0(i_6_), .Y(new_new_n82_));
  AOI210     g65(.A0(new_new_n31_), .A1(new_new_n26_), .B0(new_new_n29_), .Y(new_new_n83_));
  OR2        g66(.A(new_new_n83_), .B(new_new_n74_), .Y(new_new_n84_));
  NA3        g67(.A(new_new_n23_), .B(i_1_), .C(new_new_n26_), .Y(new_new_n85_));
  NA3        g68(.A(new_new_n85_), .B(new_new_n84_), .C(new_new_n82_), .Y(men04));
endmodule
