...
module \data/5xp1  ( 
  ...
  OR3        g21(.A(new_new_n34_), .B(new_new_n25_), .C(new_new_n19_), .Y(mai01));
  ...
  INV        g39(.A(new_new_n56_), .Y(new_new_n57_));
  OAI210     g40(.A0(new_new_n54_), .A1(new_new_n47_), .B0(new_new_n57_), .Y(mai02));
  NAi21      g41(.An(new_new_n21_), .B(new_new_n43_), .Y(new_new_n59_));
  NA3        g42(.A(i_2_), .B(i_1_), .C(i_3_), .Y(new_new_n60_));
  INV        g43(.A(new_new_n31_), .Y(new_new_n61_));
  NA2        g44(.A(new_new_n61_), .B(new_new_n59_), .Y(mai00));
  INV        g45(.A(i_5_), .Y(new_new_n63_));
  NO2        g46(.A(new_new_n63_), .B(new_new_n20_), .Y(mai09));
  NOi21      g47(.An(new_new_n36_), .B(new_new_n32_), .Y(mai07));
  INV        g48(.A(i_3_), .Y(mai08));
  INV        g49(.A(new_new_n29_), .Y(new_new_n67_));
  NA2        g50(.A(mai07), .B(new_new_n67_), .Y(new_new_n68_));
  XO2        g51(.A(new_new_n68_), .B(new_new_n28_), .Y(mai05));
  NO2        g52(.A(i_2_), .B(mai08), .Y(new_new_n70_));
  XO2        g53(.A(new_new_n70_), .B(i_1_), .Y(mai06));
  NAi21      g54(.An(new_new_n53_), .B(new_new_n45_), .Y(new_new_n72_));
  ...
  NO2        g63(.A(new_new_n80_), .B(new_new_n49_), .Y(new_new_n81_));
