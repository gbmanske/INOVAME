...
module \data/5xp1  ( 
  ...
  NO2        g32(.A(new_new_n48_), .B(new_new_n29_), .Y(new_new_n50_));
  NO3        g33(.A(new_new_n40_), .B(i_6_), .C(i_5_), .Y(new_new_n51_));
  NO3        g34(.A(new_new_n51_), .B(new_new_n50_), .C(new_new_n20_), .Y(new_new_n52_));
  ...
  OAI210     g40(.A0(new_new_n52_), .A1(new_new_n47_), .B0(new_new_n57_), .Y(men02));
  ...
  NAi21      g54(.An(new_new_n51_), .B(new_new_n45_), .Y(new_new_n72_));
