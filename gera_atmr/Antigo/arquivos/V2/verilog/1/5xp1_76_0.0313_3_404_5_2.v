...
module \data/5xp1  ( 
  ...
  AOI210     g33(.A0(new_new_n50_), .A1(new_new_n48_), .B0(new_new_n29_), .Y(new_new_n51_));
  NO3        g34(.A(new_new_n40_), .B(i_6_), .C(i_5_), .Y(new_new_n52_));
  NO3        g35(.A(new_new_n52_), .B(new_new_n51_), .C(new_new_n20_), .Y(new_new_n53_));
  ...
  OAI210     g41(.A0(new_new_n53_), .A1(new_new_n47_), .B0(new_new_n58_), .Y(men02));
  ...
  NA2        g45(.A(new_new_n62_), .B(new_new_n60_), .Y(men00));
  OAI210     g46(.A0(new_new_n54_), .A1(new_new_n37_), .B0(i_5_), .Y(new_new_n64_));
  NO2        g47(.A(new_new_n64_), .B(new_new_n20_), .Y(men09));
  NOi21      g48(.An(new_new_n36_), .B(new_new_n32_), .Y(men07));
  INV        g49(.A(i_3_), .Y(men08));
  INV        g50(.A(new_new_n29_), .Y(new_new_n68_));
  NA2        g51(.A(men07), .B(new_new_n68_), .Y(new_new_n69_));
  XO2        g52(.A(new_new_n69_), .B(new_new_n28_), .Y(men05));
  NO2        g53(.A(i_2_), .B(men08), .Y(new_new_n71_));
  XO2        g54(.A(new_new_n71_), .B(i_1_), .Y(men06));
  NAi21      g55(.An(new_new_n52_), .B(new_new_n45_), .Y(new_new_n73_));
  NA2        g56(.A(new_new_n73_), .B(i_0_), .Y(new_new_n74_));
  NO2        g57(.A(i_1_), .B(i_6_), .Y(new_new_n75_));
  NO3        g58(.A(new_new_n75_), .B(new_new_n42_), .C(new_new_n36_), .Y(new_new_n76_));
  NO2        g59(.A(new_new_n76_), .B(new_new_n38_), .Y(new_new_n77_));
  AO210      g60(.A0(new_new_n41_), .A1(new_new_n24_), .B0(new_new_n18_), .Y(new_new_n78_));
  ...
  NO2        g64(.A(new_new_n81_), .B(new_new_n49_), .Y(new_new_n82_));
  AOI210     g65(.A0(new_new_n80_), .A1(new_new_n79_), .B0(new_new_n82_), .Y(new_new_n83_));
  NA4        g66(.A(new_new_n83_), .B(new_new_n78_), .C(new_new_n77_), .D(new_new_n74_), .Y(men03));
  NA2        g67(.A(new_new_n28_), .B(men08), .Y(new_new_n85_));
  ...
  NA4        g74(.A(new_new_n91_), .B(new_new_n90_), .C(new_new_n89_), .D(new_new_n87_), .Y(men04));
endmodule
