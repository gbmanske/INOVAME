...
module \data/9sym  ( 
  ...
  NO2        g047(.A(new_new_n54_), .B(new_new_n42_), .Y(new_new_n58_));
  ...
  NA3        g124(.A(new_new_n134_), .B(new_new_n133_), .C(new_new_n117_), .Y(new_new_n135_));
  ...
  NA4        g128(.A(new_new_n67_), .B(new_new_n109_), .C(new_new_n17_), .D(new_new_n12_), .Y(new_new_n139_));
  NAi31      g129(.An(new_new_n111_), .B(new_new_n95_), .C(new_new_n109_), .Y(new_new_n140_));
  NA3        g130(.A(new_new_n69_), .B(new_new_n61_), .C(i_6_), .Y(new_new_n141_));
  ...
  NOi32      g134(.An(i_4_), .Bn(i_5_), .C(i_3_), .Y(new_new_n145_));
  NA2        g135(.A(new_new_n145_), .B(new_new_n131_), .Y(new_new_n146_));
  NA3        g136(.A(new_new_n143_), .B(new_new_n63_), .C(new_new_n37_), .Y(new_new_n147_));
  NA3        g137(.A(new_new_n147_), .B(new_new_n146_), .C(new_new_n144_), .Y(new_new_n148_));
  NA4        g138(.A(new_new_n61_), .B(i_6_), .C(new_new_n14_), .D(i_7_), .Y(new_new_n149_));
  NA4        g139(.A(new_new_n64_), .B(new_new_n39_), .C(new_new_n17_), .D(i_8_), .Y(new_new_n150_));
  NA4        g140(.A(new_new_n64_), .B(new_new_n47_), .C(i_5_), .D(new_new_n23_), .Y(new_new_n151_));
  ...
  AOI220     g144(.A0(new_new_n154_), .A1(new_new_n95_), .B0(new_new_n67_), .B1(new_new_n32_), .Y(new_new_n155_));
  NO2        g145(.A(new_new_n155_), .B(new_new_n107_), .Y(new_new_n156_));
  ...
  NA3        g158(.A(new_new_n143_), .B(new_new_n69_), .C(new_new_n113_), .Y(new_new_n169_));
  ...
  NA2        g161(.A(new_new_n57_), .B(new_new_n15_), .Y(new_new_n172_));
  NOi31      g162(.An(i_0_), .B(i_2_), .C(i_1_), .Y(new_new_n173_));
  OAI210     g163(.A0(new_new_n145_), .A1(new_new_n85_), .B0(new_new_n173_), .Y(new_new_n174_));
  ...
  OR4        g167(.A(new_new_n177_), .B(new_new_n130_), .C(new_new_n91_), .D(new_new_n73_), .Y(men00));
endmodule
