...
module \data/9sym  ( 
  ...
  NA2        g074(.A(new_new_n18_), .B(i_6_), .Y(new_new_n85_));
  ...
  OAI210     g086(.A0(new_new_n96_), .A1(new_new_n91_), .B0(new_new_n77_), .Y(new_new_n97_));
  NA3        g087(.A(new_new_n25_), .B(i_2_), .C(new_new_n14_), .Y(new_new_n98_));
  AOI210     g088(.A0(new_new_n22_), .A1(new_new_n52_), .B0(new_new_n98_), .Y(new_new_n99_));
  ...
  NA2        g091(.A(i_4_), .B(i_5_), .Y(new_new_n102_));
  NA3        g092(.A(new_new_n73_), .B(new_new_n18_), .C(new_new_n17_), .Y(new_new_n103_));
  OAI220     g093(.A0(new_new_n103_), .A1(new_new_n102_), .B0(new_new_n101_), .B1(new_new_n100_), .Y(new_new_n104_));
  NO2        g094(.A(new_new_n104_), .B(new_new_n99_), .Y(new_new_n105_));
  NA3        g095(.A(new_new_n68_), .B(new_new_n35_), .C(i_3_), .Y(new_new_n106_));
  ...
  NA3        g100(.A(new_new_n63_), .B(i_5_), .C(new_new_n23_), .Y(new_new_n111_));
  ...
  NO2        g106(.A(new_new_n115_), .B(new_new_n108_), .Y(new_new_n117_));
  NOi21      g107(.An(i_6_), .B(i_1_), .Y(new_new_n118_));
  AOI220     g108(.A0(new_new_n118_), .A1(i_7_), .B0(new_new_n25_), .B1(i_5_), .Y(new_new_n119_));
  NOi31      g109(.An(new_new_n53_), .B(new_new_n119_), .C(i_2_), .Y(new_new_n120_));
  NA2        g110(.A(new_new_n68_), .B(new_new_n12_), .Y(new_new_n121_));
  ...
  AOI220     g115(.A0(new_new_n93_), .A1(new_new_n14_), .B0(new_new_n112_), .B1(new_new_n23_), .Y(new_new_n126_));
  ...
  NA4        g118(.A(new_new_n128_), .B(new_new_n117_), .C(new_new_n105_), .D(new_new_n97_), .Y(new_new_n129_));
  NA2        g119(.A(new_new_n56_), .B(new_new_n15_), .Y(new_new_n130_));
  ...
  NA2        g123(.A(new_new_n37_), .B(new_new_n14_), .Y(new_new_n134_));
  NA4        g124(.A(new_new_n134_), .B(new_new_n133_), .C(new_new_n130_), .D(new_new_n116_), .Y(new_new_n135_));
  NA2        g125(.A(new_new_n135_), .B(new_new_n42_), .Y(new_new_n136_));
  NA2        g126(.A(new_new_n62_), .B(new_new_n38_), .Y(new_new_n137_));
  AOI210     g127(.A0(new_new_n137_), .A1(new_new_n80_), .B0(new_new_n31_), .Y(new_new_n138_));
  NA4        g128(.A(new_new_n66_), .B(new_new_n109_), .C(new_new_n17_), .D(new_new_n12_), .Y(new_new_n139_));
  NAi31      g129(.An(new_new_n110_), .B(new_new_n93_), .C(new_new_n109_), .Y(new_new_n140_));
  NA3        g130(.A(new_new_n68_), .B(new_new_n60_), .C(i_6_), .Y(new_new_n141_));
  NA3        g131(.A(new_new_n141_), .B(new_new_n140_), .C(new_new_n139_), .Y(new_new_n142_));
  NOi21      g132(.An(i_0_), .B(i_2_), .Y(new_new_n143_));
  NA3        g133(.A(new_new_n143_), .B(new_new_n38_), .C(new_new_n112_), .Y(new_new_n144_));
  NA3        g134(.A(new_new_n53_), .B(new_new_n44_), .C(new_new_n18_), .Y(new_new_n145_));
  NOi32      g135(.An(i_4_), .Bn(i_5_), .C(i_3_), .Y(new_new_n146_));
  NA2        g136(.A(new_new_n146_), .B(new_new_n131_), .Y(new_new_n147_));
  NA3        g137(.A(new_new_n143_), .B(new_new_n62_), .C(new_new_n37_), .Y(new_new_n148_));
  NA4        g138(.A(new_new_n148_), .B(new_new_n147_), .C(new_new_n145_), .D(new_new_n144_), .Y(new_new_n149_));
  NA4        g139(.A(new_new_n60_), .B(i_6_), .C(new_new_n14_), .D(i_7_), .Y(new_new_n150_));
  NA4        g140(.A(new_new_n63_), .B(new_new_n39_), .C(new_new_n17_), .D(i_8_), .Y(new_new_n151_));
  NA4        g141(.A(new_new_n63_), .B(new_new_n47_), .C(i_5_), .D(new_new_n23_), .Y(new_new_n152_));
  NA3        g142(.A(new_new_n152_), .B(new_new_n151_), .C(new_new_n150_), .Y(new_new_n153_));
  NO4        g143(.A(new_new_n153_), .B(new_new_n149_), .C(new_new_n142_), .D(new_new_n138_), .Y(new_new_n154_));
  NA2        g144(.A(new_new_n66_), .B(new_new_n32_), .Y(new_new_n155_));
  AOI210     g145(.A0(new_new_n155_), .A1(new_new_n130_), .B0(new_new_n107_), .Y(new_new_n156_));
  NO4        g146(.A(i_2_), .B(new_new_n21_), .C(new_new_n11_), .D(new_new_n14_), .Y(new_new_n157_));
  NA2        g147(.A(i_2_), .B(i_4_), .Y(new_new_n158_));
  AOI210     g148(.A0(new_new_n110_), .A1(new_new_n90_), .B0(new_new_n158_), .Y(new_new_n159_));
  NO2        g149(.A(i_8_), .B(i_7_), .Y(new_new_n160_));
  OA210      g150(.A0(new_new_n159_), .A1(new_new_n157_), .B0(new_new_n160_), .Y(new_new_n161_));
  NA4        g151(.A(new_new_n123_), .B(i_0_), .C(i_5_), .D(new_new_n23_), .Y(new_new_n162_));
  ...
  INV        g156(.A(new_new_n53_), .Y(new_new_n167_));
  AOI210     g157(.A0(new_new_n167_), .A1(new_new_n166_), .B0(new_new_n165_), .Y(new_new_n168_));
  NA3        g158(.A(new_new_n143_), .B(new_new_n68_), .C(new_new_n112_), .Y(new_new_n169_));
  OAI210     g159(.A0(new_new_n106_), .A1(new_new_n31_), .B0(new_new_n169_), .Y(new_new_n170_));
  NA4        g160(.A(new_new_n113_), .B(new_new_n66_), .C(new_new_n46_), .D(new_new_n21_), .Y(new_new_n171_));
  NA3        g161(.A(new_new_n56_), .B(new_new_n36_), .C(new_new_n15_), .Y(new_new_n172_));
  ...
  NA4        g166(.A(new_new_n176_), .B(new_new_n164_), .C(new_new_n154_), .D(new_new_n136_), .Y(new_new_n177_));
  OR4        g167(.A(new_new_n177_), .B(new_new_n129_), .C(new_new_n89_), .D(new_new_n72_), .Y(mai00));
endmodule
