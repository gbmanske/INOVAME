...
module \data/9sym  ( 
  ...
  NO2        g038(.A(new_new_n24_), .B(new_new_n48_), .Y(new_new_n49_));
  NO4        g039(.A(new_new_n49_), .B(new_new_n45_), .C(new_new_n41_), .D(new_new_n34_), .Y(new_new_n50_));
  ...
  NA4        g062(.A(new_new_n72_), .B(new_new_n60_), .C(new_new_n50_), .D(new_new_n29_), .Y(new_new_n73_));
  ...
  INV        g078(.A(i_0_), .Y(new_new_n89_));
  ...
  AOI210     g090(.A0(new_new_n22_), .A1(new_new_n52_), .B0(new_new_n100_), .Y(new_new_n101_));
  ...
  NA3        g095(.A(new_new_n69_), .B(new_new_n35_), .C(i_3_), .Y(new_new_n106_));
  NA2        g096(.A(new_new_n46_), .B(i_6_), .Y(new_new_n107_));
  AOI210     g097(.A0(new_new_n107_), .A1(new_new_n22_), .B0(new_new_n106_), .Y(new_new_n108_));
  ...
  NA2        g113(.A(new_new_n37_), .B(new_new_n14_), .Y(new_new_n124_));
  ...
  NOi31      g117(.An(new_new_n47_), .B(i_5_), .C(new_new_n35_), .Y(new_new_n128_));
  NO3        g118(.A(new_new_n128_), .B(new_new_n127_), .C(new_new_n122_), .Y(new_new_n129_));
  NA4        g119(.A(new_new_n129_), .B(new_new_n119_), .C(new_new_n105_), .D(new_new_n99_), .Y(new_new_n130_));
  NA2        g120(.A(new_new_n57_), .B(new_new_n15_), .Y(new_new_n131_));
  NOi31      g121(.An(i_6_), .B(i_1_), .C(i_8_), .Y(new_new_n132_));
  NOi31      g122(.An(i_5_), .B(i_2_), .C(i_6_), .Y(new_new_n133_));
  OAI210     g123(.A0(new_new_n133_), .A1(new_new_n132_), .B0(i_7_), .Y(new_new_n134_));
  NA3        g124(.A(new_new_n37_), .B(i_2_), .C(new_new_n14_), .Y(new_new_n135_));
  NA4        g125(.A(new_new_n135_), .B(new_new_n134_), .C(new_new_n131_), .D(new_new_n117_), .Y(new_new_n136_));
  NA2        g126(.A(new_new_n136_), .B(new_new_n42_), .Y(new_new_n137_));
  NA2        g127(.A(new_new_n63_), .B(new_new_n38_), .Y(new_new_n138_));
  AOI210     g128(.A0(new_new_n138_), .A1(new_new_n82_), .B0(new_new_n31_), .Y(new_new_n139_));
  ...
  NA3        g131(.A(new_new_n69_), .B(new_new_n61_), .C(i_6_), .Y(new_new_n142_));
  NA3        g132(.A(new_new_n142_), .B(new_new_n141_), .C(new_new_n140_), .Y(new_new_n143_));
  NOi21      g133(.An(i_0_), .B(i_2_), .Y(new_new_n144_));
  NA3        g134(.A(new_new_n144_), .B(new_new_n38_), .C(new_new_n113_), .Y(new_new_n145_));
  NOi32      g135(.An(i_4_), .Bn(i_5_), .C(i_3_), .Y(new_new_n146_));
  NA2        g136(.A(new_new_n146_), .B(new_new_n132_), .Y(new_new_n147_));
  NA3        g137(.A(new_new_n144_), .B(new_new_n63_), .C(new_new_n37_), .Y(new_new_n148_));
  NA3        g138(.A(new_new_n148_), .B(new_new_n147_), .C(new_new_n145_), .Y(new_new_n149_));
  NA4        g139(.A(new_new_n61_), .B(i_6_), .C(new_new_n14_), .D(i_7_), .Y(new_new_n150_));
  NA4        g140(.A(new_new_n64_), .B(new_new_n39_), .C(new_new_n17_), .D(i_8_), .Y(new_new_n151_));
  NA4        g141(.A(new_new_n64_), .B(new_new_n47_), .C(i_5_), .D(new_new_n23_), .Y(new_new_n152_));
  NA3        g142(.A(new_new_n152_), .B(new_new_n151_), .C(new_new_n150_), .Y(new_new_n153_));
  NO4        g143(.A(new_new_n153_), .B(new_new_n149_), .C(new_new_n143_), .D(new_new_n139_), .Y(new_new_n154_));
  NA2        g144(.A(new_new_n67_), .B(new_new_n32_), .Y(new_new_n155_));
  AOI210     g145(.A0(new_new_n155_), .A1(new_new_n131_), .B0(new_new_n107_), .Y(new_new_n156_));
  NO4        g146(.A(i_2_), .B(new_new_n21_), .C(new_new_n11_), .D(new_new_n14_), .Y(new_new_n157_));
  NA2        g147(.A(i_2_), .B(i_4_), .Y(new_new_n158_));
  AOI210     g148(.A0(new_new_n111_), .A1(new_new_n92_), .B0(new_new_n158_), .Y(new_new_n159_));
  NO2        g149(.A(i_8_), .B(i_7_), .Y(new_new_n160_));
  OA210      g150(.A0(new_new_n159_), .A1(new_new_n157_), .B0(new_new_n160_), .Y(new_new_n161_));
  NA4        g151(.A(new_new_n125_), .B(i_0_), .C(i_5_), .D(new_new_n23_), .Y(new_new_n162_));
  NO2        g152(.A(new_new_n162_), .B(i_4_), .Y(new_new_n163_));
  NO3        g153(.A(new_new_n163_), .B(new_new_n161_), .C(new_new_n156_), .Y(new_new_n164_));
  NA2        g154(.A(new_new_n95_), .B(new_new_n12_), .Y(new_new_n165_));
  NA2        g155(.A(i_1_), .B(new_new_n14_), .Y(new_new_n166_));
  NA2        g156(.A(new_new_n54_), .B(i_3_), .Y(new_new_n167_));
  AOI210     g157(.A0(new_new_n167_), .A1(new_new_n166_), .B0(new_new_n165_), .Y(new_new_n168_));
  NA3        g158(.A(new_new_n144_), .B(new_new_n69_), .C(new_new_n113_), .Y(new_new_n169_));
  OAI210     g159(.A0(new_new_n106_), .A1(new_new_n31_), .B0(new_new_n169_), .Y(new_new_n170_));
  NA4        g160(.A(new_new_n114_), .B(new_new_n67_), .C(new_new_n46_), .D(new_new_n21_), .Y(new_new_n171_));
  NA3        g161(.A(new_new_n96_), .B(new_new_n125_), .C(i_0_), .Y(new_new_n172_));
  NA3        g162(.A(new_new_n57_), .B(new_new_n36_), .C(new_new_n15_), .Y(new_new_n173_));
  NOi31      g163(.An(i_0_), .B(i_2_), .C(i_1_), .Y(new_new_n174_));
  OAI210     g164(.A0(new_new_n146_), .A1(new_new_n85_), .B0(new_new_n174_), .Y(new_new_n175_));
  NA4        g165(.A(new_new_n175_), .B(new_new_n173_), .C(new_new_n172_), .D(new_new_n171_), .Y(new_new_n176_));
  NO3        g166(.A(new_new_n176_), .B(new_new_n170_), .C(new_new_n168_), .Y(new_new_n177_));
  NA4        g167(.A(new_new_n177_), .B(new_new_n164_), .C(new_new_n154_), .D(new_new_n137_), .Y(new_new_n178_));
  OR4        g168(.A(new_new_n178_), .B(new_new_n130_), .C(new_new_n91_), .D(new_new_n73_), .Y(men00));
endmodule
