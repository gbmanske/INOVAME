...
module \data/9sym  ( 
  ...
  AOI210     g086(.A0(new_new_n96_), .A1(new_new_n22_), .B0(new_new_n95_), .Y(new_new_n97_));
  ...
  OR4        g153(.A(new_new_n163_), .B(new_new_n120_), .C(new_new_n79_), .D(new_new_n63_), .Y(zz00));
endmodule
