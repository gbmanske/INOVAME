...
module \data/9sym  ( 
  ...
  AOI210     g044(.A0(new_new_n54_), .A1(new_new_n24_), .B0(new_new_n15_), .Y(new_new_n55_));
  ...
  NA2        g123(.A(new_new_n133_), .B(i_7_), .Y(new_new_n134_));
  NA2        g124(.A(new_new_n36_), .B(new_new_n14_), .Y(new_new_n135_));
  NA4        g125(.A(new_new_n135_), .B(new_new_n134_), .C(new_new_n132_), .D(new_new_n117_), .Y(new_new_n136_));
  ...
  NA4        g139(.A(new_new_n64_), .B(new_new_n38_), .C(new_new_n17_), .D(i_8_), .Y(new_new_n150_));
  NA4        g140(.A(new_new_n64_), .B(new_new_n46_), .C(i_5_), .D(new_new_n22_), .Y(new_new_n151_));
  NA3        g141(.A(new_new_n151_), .B(new_new_n150_), .C(new_new_n149_), .Y(new_new_n152_));
  NO4        g142(.A(new_new_n152_), .B(new_new_n148_), .C(new_new_n143_), .D(new_new_n139_), .Y(new_new_n153_));
  AOI220     g143(.A0(i_5_), .A1(new_new_n95_), .B0(new_new_n67_), .B1(new_new_n31_), .Y(new_new_n154_));
  ...
  NA3        g160(.A(new_new_n57_), .B(new_new_n35_), .C(new_new_n15_), .Y(new_new_n171_));
  NOi31      g161(.An(i_0_), .B(i_2_), .C(i_1_), .Y(new_new_n172_));
  NA2        g162(.A(new_new_n85_), .B(new_new_n172_), .Y(new_new_n173_));
  NA3        g163(.A(new_new_n173_), .B(new_new_n171_), .C(new_new_n170_), .Y(new_new_n174_));
  NO3        g164(.A(new_new_n174_), .B(new_new_n169_), .C(new_new_n167_), .Y(new_new_n175_));
  NA4        g165(.A(new_new_n175_), .B(new_new_n163_), .C(new_new_n153_), .D(new_new_n137_), .Y(new_new_n176_));
  OR4        g166(.A(new_new_n176_), .B(new_new_n131_), .C(new_new_n91_), .D(new_new_n73_), .Y(mai00));
endmodule
