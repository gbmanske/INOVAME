...
-- pin_name3	=>  Location: PIN_B6,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- Equation(s):
-- \inst2~0_combout\ = (\pin_name3~input_o\ & (\b~input_o\)) # (!\pin_name3~input_o\ & ((\a~input_o\)))
