...
# Generated on: Thu Jan 30 23:07:08 -03 2025 (Fri Jan 31 02:07:08 UTC 2025)
...
set logfile fv/alu_WIDTH8/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/alu_WIDTH8 -revised fv_map -use_rtl_names
...
elaborate_design -golden -root {alu} -rootonly -rootonly  -parameter -int {WIDTH} "8"

read_design -verilog95   -revised -lastmod -noelab fv/alu_WIDTH8/fv_map.v.gz
elaborate_design -revised -root {alu_WIDTH8}
...
set_analyze_option -mapping_file fv/alu_WIDTH8/fv_map.map.do
...
set_system_mode lec
write_compared_points noneq.compared_points.alu_WIDTH8.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.alu_WIDTH8.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.alu_WIDTH8.rtl.fv_map.rpt
