...
#                script (type 'D_and_gate.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.D_and_gate xil_defaultlib.glbl -o D_and_gate_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./D_and_gate_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key D_and_gate_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc D_and_gate_simv.daidir vcs_lib c.obj)
