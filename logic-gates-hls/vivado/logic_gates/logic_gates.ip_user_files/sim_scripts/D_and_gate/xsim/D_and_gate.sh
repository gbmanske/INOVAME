...
#
# Script generated by Vivado on Tue Jan 14 14:57:50 -03 2025
# SW Build 4029153 on Fri Oct 13 20:13:54 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : D_and_gate.sh
...
#
# Usage        : D_and_gate.sh
#                D_and_gate.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                D_and_gate.sh [-reset_run]
#                D_and_gate.sh [-reset_log]
#                D_and_gate.sh [-help]
#
...
# script info
echo -e "D_and_gate.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./D_and_gate.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot D_and_gate xil_defaultlib.D_and_gate xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim D_and_gate -key {Behavioral:sim_1:Functional:D_and_gate} -tclbatch cmd.tcl -protoinst "protoinst_files/D_and_gate.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/tools/amd/Vivado/2023.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb D_and_gate.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./D_and_gate.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: D_and_gate.sh [-help]\n\
Usage: D_and_gate.sh [-step]\n\
Usage: D_and_gate.sh [-lib_map_path]\n\
Usage: D_and_gate.sh [-reset_run]\n\
Usage: D_and_gate.sh [-reset_log]\n\
Usage: D_and_gate.sh [-keep_index]\n\
Usage: D_and_gate.sh [-noclean_files]\n\n\
