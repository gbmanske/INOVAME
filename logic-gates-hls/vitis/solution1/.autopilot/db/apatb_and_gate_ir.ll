; ModuleID = '/home/gme/guilherme.manske/logic-gates-hls/vitis/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: inaccessiblemem_or_argmemonly noinline willreturn
define void @apatb_and_gate_ir(i1* noalias nocapture nonnull dereferenceable(1) %res, i1* noalias nocapture nonnull readonly dereferenceable(1) %a, i1* noalias nocapture nonnull readonly dereferenceable(1) %b) local_unnamed_addr #0 {
entry:
  %res_copy = alloca i1, align 512
  %a_copy = alloca i1, align 512
  %b_copy = alloca i1, align 512
  call fastcc void @copy_in(i1* nonnull %res, i1* nonnull align 512 %res_copy, i1* nonnull %a, i1* nonnull align 512 %a_copy, i1* nonnull %b, i1* nonnull align 512 %b_copy)
  call void @apatb_and_gate_hw(i1* %res_copy, i1* %a_copy, i1* %b_copy)
  call void @copy_back(i1* %res, i1* %res_copy, i1* %a, i1* %a_copy, i1* %b, i1* %b_copy)
  ret void
}
...
declare void @apatb_and_gate_hw(i1*, i1*, i1*)
...
define void @and_gate_hw_stub_wrapper(i1*, i1*, i1*) #4 {
entry:
  call void @copy_out(i1* null, i1* %0, i1* null, i1* %1, i1* null, i1* %2)
  call void @and_gate_hw_stub(i1* %0, i1* %1, i1* %2)
  call void @copy_in(i1* null, i1* %0, i1* null, i1* %1, i1* null, i1* %2)
  ret void
}

declare void @and_gate_hw_stub(i1*, i1*, i1*)
