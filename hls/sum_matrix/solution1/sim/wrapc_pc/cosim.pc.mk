...
$(ObjDir)/sum_matrix_test.cpp_pre.cpp.tb.o : sum_matrix_test.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling sum_matrix_test.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c -Wno-unknown-pragmas -Wno-unknown-pragmas $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/sum_matrix.cpp_pre.cpp.tb.o : sum_matrix.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling sum_matrix.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
