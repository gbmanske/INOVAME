...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.kernel.autotvin_gmem0.dat"
         "c.kernel.autotvin_gmem1.dat"
         "c.kernel.autotvin_in1.dat"
         "c.kernel.autotvin_in2.dat"
         "c.kernel.autotvin_out_r.dat"
         "c.kernel.autotvin_vCol.dat"
         "c.kernel.autotvin_vRow.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.kernel.autotvout_gmem0.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
