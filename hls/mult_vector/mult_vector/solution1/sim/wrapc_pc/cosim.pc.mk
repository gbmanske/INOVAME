...
$(ObjDir)/mult_vector_test.cpp_pre.cpp.tb.o : mult_vector_test.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling mult_vector_test.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c -Wno-unknown-pragmas -Wno-unknown-pragmas $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/mult_vector.cpp_pre.cpp.tb.o : mult_vector.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling mult_vector.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
