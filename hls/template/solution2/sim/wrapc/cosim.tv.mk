...
$(ObjDir)/template_test.cpp_pre.cpp.tb.o : template_test.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling template_test.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c -Wno-unknown-pragmas -Wno-unknown-pragmas $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/template.cpp_pre.cpp.tb.o : template.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling template.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
