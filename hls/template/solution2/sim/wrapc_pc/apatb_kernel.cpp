...
#define AUTOTB_TVOUT_vSize "../tv/cdatafile/c.kernel.autotvout_vSize.dat"
...
extern "C"
void kernel_hw_stub_wrapper(void*, void*, void*, hls::sim::Byte<4>);

extern "C"
void apatb_kernel_hw(void* __xlx_apatb_param_in1, void* __xlx_apatb_param_in2, void* __xlx_apatb_param_out_r, hls::sim::Byte<4> __xlx_apatb_param_vSize)
{
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_vSize),
#endif
  };
  port3.param = &__xlx_apatb_param_vSize;
  ...
  __xlx_offset_byte_param_in1 = 0*128;
  __xlx_offset_byte_param_out_r = 4096*128;
  port4.param = { __xlx_apatb_param_in1, __xlx_apatb_param_out_r };
  port4.nbytes = { 524288, 524288 };
  port4.offset = { 0, 4096 };
  ...
  try {
    ...
    kernel_hw_stub_wrapper(__xlx_apatb_param_in1, __xlx_apatb_param_in2, __xlx_apatb_param_out_r, __xlx_apatb_param_vSize);
