...
$(ObjDir)/raiz_test.cpp_pre.cpp.tb.o : raiz_test.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling raiz_test.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c -Wno-unknown-pragmas -Wno-unknown-pragmas $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/raiz.cpp_pre.cpp.tb.o : raiz.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling raiz.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
