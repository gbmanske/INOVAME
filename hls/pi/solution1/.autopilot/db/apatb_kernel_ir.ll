; ModuleID = '/home/gme/guilherme.manske/hls/pi/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: noinline optnone
define double @apatb_kernel_ir(i64 %terms) local_unnamed_addr #0 {
entry:
  call fastcc void @copy_in()
  %0 = call double @apatb_kernel_hw(i64 %terms)
  call void @copy_back()
  ret double %0
}
...
declare double @apatb_kernel_hw(i64)
...
define double @kernel_hw_stub_wrapper(i64) #3 {
entry:
  call void @copy_out()
  %1 = call double @kernel_hw_stub(i64 %0)
  call void @copy_in()
  ret double %1
}

declare double @kernel_hw_stub(i64)
