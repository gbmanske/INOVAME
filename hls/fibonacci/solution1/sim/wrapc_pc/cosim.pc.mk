...
$(ObjDir)/fibonacci_test.cpp_pre.cpp.tb.o : fibonacci_test.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling fibonacci_test.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c -Wno-unknown-pragmas -Wno-unknown-pragmas $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/fibonacci.cpp_pre.cpp.tb.o : fibonacci.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling fibonacci.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
