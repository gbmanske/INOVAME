...
probe -create -database waves tb.dut.cont tb.dut.X tb.dut.Y tb.dut.state tb.dut.start tb.dut.start_mult tb.dut.end_expo tb.dut.end_mult tb.dut.resultado tb.dut.reset
