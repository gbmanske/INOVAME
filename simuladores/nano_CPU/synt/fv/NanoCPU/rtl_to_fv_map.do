...
# Generated on: Tue Dec 17 16:33:29 -03 2024 (Tue Dec 17 19:33:29 UTC 2024)
...
set logfile fv/NanoCPU/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/NanoCPU -revised fv_map -use_rtl_names
...
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -sv09 ../rtl/nanoCPU.sv
elaborate_design -golden -root {NanoCPU} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/NanoCPU/fv_map.v.gz
elaborate_design -revised -root {NanoCPU}
...
set_analyze_option -mapping_file fv/NanoCPU/fv_map.map.do
...
set_system_mode lec
write_compared_points noneq.compared_points.NanoCPU.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.NanoCPU.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.NanoCPU.rtl.fv_map.rpt
