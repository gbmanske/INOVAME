...
# Generated on: Wed Dec 18 17:11:13 -03 2024 (Wed Dec 18 20:11:13 UTC 2024)
...
set logfile fv/mult_serial/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/mult_serial -revised fv_map -use_rtl_names
...
elaborate_design -golden -root {mult_serial} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/mult_serial/fv_map.v.gz
elaborate_design -revised -root {mult_serial}
...
set_analyze_option -mapping_file fv/mult_serial/fv_map.map.do
...
write_compared_points noneq.compared_points.mult_serial.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.mult_serial.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.mult_serial.rtl.fv_map.rpt
