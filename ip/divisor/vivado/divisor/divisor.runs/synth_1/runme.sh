...
HD_PWD='/home/gme/guilherme.manske/ip/divisor/vivado/divisor/divisor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log D_divisor_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source D_divisor_wrapper.tcl
