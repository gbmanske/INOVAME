...
HD_PWD='/home/gme/guilherme.manske/ip/divisor/vivado/divisor/divisor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log D_divisor_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source D_divisor_wrapper.tcl -notrace
